...
from .models import AgentLaneData, ApprovalRequest
...
def build_codex_lane(
    ...
    status_hint = _codex_status_hint(poll_status, last_codex_poll)
...
def build_claude_lane(sections: dict[str, str]) -> AgentLaneData:
    ...
    status_hint = _claude_status_hint(status)
