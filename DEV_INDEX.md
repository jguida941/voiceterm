# Developer Index (Bridge)

`dev/README.md` is the canonical developer index for this repo.

Start here:

- [Canonical Developer Index](dev/README.md)
...
- [Portable Code Governance Guide](dev/guides/PORTABLE_CODE_GOVERNANCE.md)
...
- [Operator Console Theme Map](app/operator_console/theme/README.md)
- [Operator Console State Map](app/operator_console/state/README.md)
- [Operator Console Test Map](app/operator_console/tests/README.md)
- [Review Channel Plan](dev/active/review_channel.md)
- [Host Process Hygiene Plan](dev/active/host_process_hygiene.md)
- [Continuous Swarm Plan](dev/active/continuous_swarm.md)
...
- [Portable Code Governance Plan](dev/active/portable_code_governance.md)
