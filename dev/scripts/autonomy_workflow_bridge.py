...
try:
    ...
    from workflow_bridge.controller_config import (
        resolve_controller_config_from_env,
        write_controller_config_outputs,
    )
    from workflow_bridge.ralph_config import (
        resolve_ralph_config_from_env,
        write_ralph_config_outputs,
    )
    from workflow_bridge.report_exports import (
        assert_swarm_ok,
        export_controller,
        export_swarm,
    )
    from workflow_bridge.swarm_config import (
        resolve_swarm_config_from_env,
        write_swarm_config_outputs,
    )
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    controller = sub.add_parser(
        "export-controller",
        help="Export autonomy-controller outputs",
    )
    ...
    assert_ok = sub.add_parser(
        "assert-swarm-ok",
        help="Exit non-zero when swarm payload is not ok",
    )
