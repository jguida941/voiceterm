...
- `review-channel --action status|ensure|reviewer-heartbeat|reviewer-checkpoint`
  ...
  forever. That recovery replaces only the stale Claude conductor; full
  `rollover` still handles bounded round/context rotation.
