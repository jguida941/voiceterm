...
| `dev/scripts/checks/check_runtime_bridge_projection_separation.py` | Runtime bridge projection-separation guard | Stable shim entrypoint for the runtime bridge projection-separation guard while the implementation lives under `dev/scripts/checks/runtime_bridge_projection_separation/`; blocks runtime and review-channel command surfaces from treating generated bridge projections as backend authority. |
