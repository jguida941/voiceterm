...
_handler_kind = import_attr("review_probes.exception_quality_support", "handler_kind")
_iter_generic_translation_raises = import_attr(
    "review_probes.exception_quality_support",
    "iter_generic_translation_raises",
)
