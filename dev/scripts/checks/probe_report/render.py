...
Programmatic imports may use this package module directly:
    from probe_report.render import render_rich_report

The stable root wrapper remains:
    python3 dev/scripts/checks/probe_report_render.py
"""
