    ...
    while True:
        ...
        if not runs and branch_filter:
            ...
            if (
                ...
                report["warnings"].append(
                    "the requested target branch does not yet contain this commit; "
                    "target-branch workflow runs are treated as non-blocking until "
                    "the commit is published there."
                )
                return report
