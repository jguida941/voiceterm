...
METRIC_KEYS = import_attr("rust_analysis.best_practices_render", "METRIC_KEYS")
_format_aggregate_growth = import_attr(
    "rust_analysis.best_practices_render", "format_aggregate_growth"
)
_format_violation_growth = import_attr(
    "rust_analysis.best_practices_render", "format_violation_growth"
)
_count_pub_unsafe_fn_missing_safety_docs = import_attr(
    "rust_analysis.best_practices_safety", "count_pub_unsafe_fn_missing_safety_docs"
)
_count_undocumented_unsafe_blocks = import_attr(
    "rust_analysis.best_practices_safety", "count_undocumented_unsafe_blocks"
)
_count_unsafe_impl_missing_safety_comment = import_attr(
    "rust_analysis.best_practices_safety", "count_unsafe_impl_missing_safety_comment"
)
