...
def main() -> int:
    ...
    parser.add_argument("--label", default="Mutation", help="Badge label")
    ...
    except Exception as exc:  # broad-except: allow reason=mutation outcome payloads vary across shards and tool versions fallback=render failed badge for workflow consumers
        write_badge(output_path, args.label, "failed", "red")
