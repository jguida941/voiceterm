...
def _build_marker(prefix: str, target: dict[str, Any]) -> str:
    """Build an HTML comment marker with the given prefix and target metadata."""
...
def comment_marker(target: dict[str, Any]) -> str:
    return _build_marker("coderabbit-ralph-loop", target)
