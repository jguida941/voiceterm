"""Runtime and push-state helpers for status projections."""
    ...
    try:
        ...
        return asdict(
            PushEnforcementSnapshot(
                ...
                ahead_of_upstream_source_commits=None,
                ahead_of_upstream_managed_receipt_commits=0,
                ahead_of_upstream_unclassified_commits=None,
                dirty_path_count=0,
