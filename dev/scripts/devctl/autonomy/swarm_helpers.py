...
from .swarm_render import render_swarm_markdown
...
def build_swarm_charts(
    ...
    # broad-except: allow reason=Optional plotting dependency should fail soft fallback=emit textual swarm diagnostics without chart assets.
