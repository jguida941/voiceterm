...
BASE_ARGUMENTS: list[ArgumentDef] = [
    ...
    _arg("--plan-doc", default="dev/active/autonomous_control_plane.md"),
    _arg("--index-doc", default="dev/active/INDEX.md"),
    _arg("--master-plan-doc", default="dev/active/MASTER_PLAN.md"),
