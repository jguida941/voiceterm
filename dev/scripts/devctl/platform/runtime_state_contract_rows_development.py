...
DEVELOPMENT_STATE_CONTRACTS: tuple[ContractSpec, ...] = (
    ...
    ContractSpec(
        ...
        required_fields=(
            ...
            ContractField(
                "campaign",
                "DevelopmentCampaignReport | None",
                (
                    "Read-only remote-control Codex/Claude campaign view. It "
                    "projects role lanes, remote-control proof, mode drift, "
                    "and mutation/publication gates without scheduling work."
                ),
            ),
            ContractField(
                "design_preflight",
    ...
    ContractSpec(
        ...
        required_fields=(
            ...
            ContractField("summary", "str", "Human-readable summary."),
            ContractField("remote_control_provider", "str", "Provider carrying remote-control transport."),
            ContractField("remote_control_status", "str", "Attachment status."),
            ContractField("remote_control_active", "bool", "Whether attachment is fresh and active."),
            ContractField("remote_control_identity_bound", "bool", "Whether attachment has physical remote identity."),
            ContractField("remote_control_session_id", "str", "Physical remote-control session id."),
            ContractField("remote_control_age_seconds", "int", "Attachment age in seconds, or -1."),
            ContractField("physical_remote_control_confirmed", "bool", "Whether physical remote control was observed."),
            ...
            ContractField("operator_interaction_mode", "str", "Typed operator interaction mode."),
            ...
            ContractField("publication_allowed", "bool", "Whether typed gates allow publication."),
            ...
            ContractField("roles", "tuple[DevelopmentCampaignRoleState, ...]", "Campaign role rows."),
            ContractField("proof_requirements", "tuple[str, ...]", "Proof gates for campaign success."),
        ),
