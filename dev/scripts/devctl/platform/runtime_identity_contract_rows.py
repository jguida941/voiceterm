...
RUNTIME_IDENTITY_CONTRACTS: tuple[ContractSpec, ...] = (
    ...
    ContractSpec(
        ...
        required_fields=(
            ...
            ContractField("pipeline_generation_id", "str", "Pipeline generation bound to approval and execution."),
            ContractField("plan_row_id", "str", "Plan row or work-intake ref advanced by the commit."),
            ContractField("reviewer_ack_packet_id", "str", "Reviewer ack or decision packet bound into the evidence chain."),
            ContractField("approval_packet_id", "str", "Approval request packet for the governed commit."),
            ContractField("decision_packet_id", "str", "Approval/ack decision packet for the governed commit."),
            ContractField("audit_synthesis_ref", "str", "Reviewer audit, validation receipt, or guard ref proving the commit."),
