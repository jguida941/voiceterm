...
from .loop_packet_context import build_loop_packet_context_packet
from .loop_packet_probe_guidance import load_loop_packet_probe_guidance
from .loop_packet_sources import (
...
def _build_packet_body(
    *,
    ...
    by_severity = rollup.get("by_severity") if isinstance(payload.get("by_severity"), dict) else {}
