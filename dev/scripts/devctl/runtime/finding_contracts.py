...
FINDING_CONTRACT_ID = "Finding"
FINDING_SCHEMA_VERSION = 1
DECISION_PACKET_CONTRACT_ID = "DecisionPacket"
DECISION_PACKET_SCHEMA_VERSION = 1
PROBE_REPORT_CONTRACT_ID = "ProbeReport"
PROBE_REPORT_SCHEMA_VERSION = 1
PROBE_REVIEW_PACKET_CONTRACT_ID = "ReviewPacket"
PROBE_REVIEW_PACKET_SCHEMA_VERSION = 1
PROBE_REVIEW_TARGETS_CONTRACT_ID = "ReviewTargets"
PROBE_REVIEW_TARGETS_SCHEMA_VERSION = 1
PROBE_TOPOLOGY_CONTRACT_ID = "FileTopology"
PROBE_TOPOLOGY_SCHEMA_VERSION = 1
PROBE_ALLOWLIST_CONTRACT_ID = "ProbeAllowlist"
PROBE_ALLOWLIST_SCHEMA_VERSION = 1
PROBE_RULE_VERSION = 1
REVIEW_PACKET_CONTRACT_ID = PROBE_REVIEW_PACKET_CONTRACT_ID
REVIEW_PACKET_SCHEMA_VERSION = PROBE_REVIEW_PACKET_SCHEMA_VERSION
REVIEW_TARGETS_CONTRACT_ID = PROBE_REVIEW_TARGETS_CONTRACT_ID
REVIEW_TARGETS_SCHEMA_VERSION = PROBE_REVIEW_TARGETS_SCHEMA_VERSION
