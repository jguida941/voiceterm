...
def _packet_attention_from_mapping(value: object) -> PacketAttentionState:
    ...
    return PacketAttentionState(
        ...
        absorption_required=_bool(payload.get("absorption_required")),
        absorption_packet_id=_string(payload.get("absorption_packet_id")),
        absorption_command=_string(payload.get("absorption_command")),
        absorption_reason=_string(payload.get("absorption_reason")),
        superseded_packet_id=_string(payload.get("superseded_packet_id")),
        pivot_required=_bool(payload.get("pivot_required")),
