...
def _participants_from_value(
    ...
    return tuple(
        CollaborationParticipantState(
            ...
            host_wake_mode=_string(mapping.get("host_wake_mode")),
            wake_interval_seconds=_int(mapping.get("wake_interval_seconds")),
            host_wake_summary=_string(mapping.get("host_wake_summary")),
