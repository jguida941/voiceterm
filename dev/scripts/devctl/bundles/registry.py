...
_GUARD_CHECKS: Final[tuple[str, ...]] = (
    ...
    check_script_shell_command("python_broad_except"),
    check_script_shell_command("structural_complexity"),
    check_script_shell_command("duplicate_types"),
    check_script_shell_command("package_layout"),
    check_script_shell_command("command_source_validation"),
    check_script_shell_command("registry_path_integrity"),
    check_script_shell_command("runtime_spine_closure"),
    check_script_shell_command("provider_list_parity_graph"),
    check_script_shell_command("no_new_hardcoded_provider_authority"),
    check_script_shell_command("no_new_topology_count_coupling"),
...
_SHARED_GOVERNANCE_CHECKS: Final[tuple[str, ...]] = (
    ...
    check_script_shell_command("guardir_extraction_plan_artifacts"),
    ...
    check_script_shell_command("commit_complete_proof"),
