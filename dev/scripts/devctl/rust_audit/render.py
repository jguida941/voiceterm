...
def build_rust_audit_charts(
    ...
    except Exception as exc:  # pragma: no cover - broad-except: allow reason=optional chart rendering must degrade when matplotlib is unavailable fallback=emit markdown/json audit report without chart assets
