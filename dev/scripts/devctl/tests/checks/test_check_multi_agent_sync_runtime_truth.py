...
class CheckMultiAgentSyncRuntimeTruthTests(unittest.TestCase):
    ...
    @patch("dev.scripts.checks.multi_agent_sync.runtime_truth.load_review_state_payload")
    def test_runtime_truth_allows_stale_pending_route_without_loop_decision(
        self,
        load_payload_mock,
        relpath_mock,
    ) -> None:
        ...
        load_payload_mock.return_value = {
            ...
            "agent_sync": {
                "agents": {
                    "claude": {
                        "pending_packets_to_me": ["rev_pkt_stale"],
                    }
                }
            },
            "packets": [
    ...
    @patch("dev.scripts.checks.multi_agent_sync.runtime_truth.load_review_state_payload")
    def test_runtime_truth_ignores_operator_pending_packets_without_packet_rows(
        self,
        load_payload_mock,
        relpath_mock,
    ) -> None:
        ...
        load_payload_mock.return_value = {
            ...
            "agent_sync": {
                "agents": {
                    "operator": {
                        "pending_packets_to_me": ["rev_pkt_missing_notice"],
                    },
                }
            },
            "packets": [],
