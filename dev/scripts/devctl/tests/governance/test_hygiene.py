...
class HygieneAuditTests(unittest.TestCase):
    ...
    def test_hygiene_parser_accepts_strict_release_warnings_flag(self) -> None:
        parser = build_parser()
        args = parser.parse_args(["hygiene", "--strict-release-warnings"])
        self.assertTrue(args.strict_release_warnings)
    ...
    def test_hygiene_parser_accepts_publications_warning_source(self) -> None:
        parser = build_parser()
        args = parser.parse_args(["hygiene", "--ignore-warning-source", "publications"])
        self.assertEqual(args.ignore_warning_source, ["publications"])
    ...
    @mock.patch(
        "dev.scripts.devctl.commands.governance.hygiene._scan_voiceterm_test_processes",
        return_value=([], []),
    )
    @mock.patch(
        "dev.scripts.devctl.commands.governance.hygiene.build_reports_hygiene_guard",
        return_value={
    ...
    @mock.patch("dev.scripts.devctl.commands.governance.hygiene.write_output")
    ...
    @mock.patch(
        "dev.scripts.devctl.commands.governance.hygiene._audit_scripts",
        return_value={
            "top_level_scripts": [],
            "check_scripts": [],
            "pycache_dirs": [],
    ...
    @mock.patch(
        "dev.scripts.devctl.commands.governance.hygiene._audit_adrs",
        return_value={"total_adrs": 0, "warnings": [], "errors": []},
    )
    @mock.patch(
        "dev.scripts.devctl.commands.governance.hygiene._audit_archive",
    ...
    @mock.patch(
        "dev.scripts.devctl.commands.governance.hygiene._audit_mutation_badge",
        return_value={
    ...
    @mock.patch(
        "dev.scripts.devctl.commands.governance.hygiene._audit_publication_sync",
        return_value={
            "registry_path": "dev/config/publication_sync_registry.json",
            "publication_count": 1,
            "stale_publication_count": 1,
            "publications": [],
            "warnings": ["Publication drift should stay visible."],
            "errors": [],
            "notices": [],
        },
    )
    ...
    @mock.patch(
        "dev.scripts.devctl.commands.governance.hygiene.head_matches_release_branch",
        return_value=False,
    )
    @mock.patch("dev.scripts.devctl.commands.governance.hygiene.load_push_policy")
    def test_hygiene_strict_release_warnings_ignores_release_maintenance_sources(
        self,
        load_push_policy_mock: mock.Mock,
        _head_matches_release_branch_mock: mock.Mock,
        _archive_mock: mock.Mock,
        _adr_mock: mock.Mock,
        _scripts_mock: mock.Mock,
        _publication_sync_mock: mock.Mock,
        _mutation_badge_mock: mock.Mock,
        _scan_mock: mock.Mock,
        _reports_mock: mock.Mock,
        write_output_mock: mock.Mock,
        ...
        payload = json.loads(write_output_mock.call_args.args[0])
        self.assertTrue(payload["ok"])
        self.assertTrue(payload["strict_release_warnings"])
        self.assertEqual(payload["warning_count"], 2)
        self.assertEqual(payload["warning_fail_count"], 0)
        self.assertEqual(
            payload["ignored_warning_sources"],
            ["mutation_badge", "publications"],
        )
        self.assertEqual(payload["ignored_warning_count"], 2)
