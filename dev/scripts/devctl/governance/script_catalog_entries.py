"""Static script id to filename entries for the devctl script catalog."""
...
CHECK_SCRIPT_ENTRIES = (
    ...
    (
        ...
        "check_contract_consumer_coverage_sweep.py",
    ),
    ("current_plan_authority", "check_current_plan_authority.py"),
    ("current_row_proof_bundle", "check_current_row_proof_bundle.py"),
    ("staging_source_ingested", "check_staging_source_ingested.py"),
    ("role_lane_mutation_authority", "check_role_lane_mutation_authority.py"),
    ("active_topology_liveness", "check_active_topology_liveness.py"),
    ("provider_pre_tool_hook_coverage", "check_provider_pre_tool_hook_coverage.py"),
    ("pre_commit_guard_coverage", "check_pre_commit_guard_coverage.py"),
    ("slice_finishes_or_reverts", "check_slice_finishes_or_reverts.py"),
    ("orphan_files", "check_orphan_files.py"),
    ("feature_completion", "check_feature_completion.py"),
    ("plan_row_must_advance", "check_plan_row_must_advance.py"),
    (
        "no_ingestion_churn_without_advancement",
        "check_no_ingestion_churn_without_advancement.py",
    ),
    ("receipt_schema_validation", "check_receipt_schema_validation.py"),
    (
    ...
    (
        ...
        "check_receipt_store_coverage_sweep.py",
    ),
    (
    ...
    (
        ...
        "check_receipt_commit_anchor_refs.py",
    ),
    (
    ...
    ("no_prose_authority_promotion", "check_no_prose_authority_promotion.py"),
    ...
    ("packet_body_observation_route", "check_packet_body_observation_route.py"),
    ...
    ("action_request_expiry_refresh", "check_action_request_expiry_refresh.py"),
    ("child_actor_scope", "check_child_actor_scope.py"),
    ("continuation_anchor_enforcement", "check_continuation_anchor_enforcement.py"),
    ("loose_chat_to_typed_lane", "check_loose_chat_to_typed_lane.py"),
    ("multi_actor_merge_conflict", "check_multi_actor_merge_conflict.py"),
    ("packet_hygiene_enforcement", "check_packet_hygiene_enforcement.py"),
    ("patch_submission_merge_gate", "check_patch_submission_merge_gate.py"),
    (
        "typed_agent_spawn_authority",
        "check_typed_agent_spawn_authority.py",
    ),
    ("peer_lease_visibility", "check_peer_lease_visibility.py"),
    ("reviewer_result_transition", "check_reviewer_result_transition.py"),
    ("role_cardinality_bounds", "check_role_cardinality_bounds.py"),
    ("role_delegation_authority", "check_role_delegation_authority.py"),
    ("role_round_closure", "check_role_round_closure.py"),
    ("shared_round_state_observed", "check_shared_round_state_observed.py"),
    ("subagent_no_commit_push", "check_subagent_no_commit_push.py"),
    ("write_lease_conflicts", "check_write_lease_conflicts.py"),
)

PROBE_SCRIPT_ENTRIES = (
...
LEGACY_ENTRYPOINT_REWRITE_ENTRIES = (
