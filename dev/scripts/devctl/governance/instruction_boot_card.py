...
def build_instruction_boot_card(
    *,
    ...
    lines = [
        ...
        "- Guard-enforcement inventory treats shared guards, governed internal pipeline lanes, explicit contextual-input exemptions, and governance-closure CI smoke coverage as separate states; do not run no-subject contextual guards as release commands just to satisfy catalog coverage, and use `--stdin --allow-empty` only for CI smoke while live proof still requires typed input, receipts, or the governed push adapter.",
