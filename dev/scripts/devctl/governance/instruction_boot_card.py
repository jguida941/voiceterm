...
def build_instruction_boot_card(
    *,
    ...
    lines = [
        ...
        "- Guard-enforcement inventory treats shared guards, governed internal pipeline lanes, and explicit contextual-input exemptions as separate states; do not run no-subject contextual guards as release commands just to satisfy catalog coverage.",
