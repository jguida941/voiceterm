...
|---|---:|---|
| `dev/scripts/devctl` | 2384 | commands=612, tests=584, runtime=430, review_channel=310, platform=84, governance=74, (root)=63, context_graph=47 |
| `dev/scripts/checks` | 501 | (root)=162, package_layout=32, platform_contract_closure=22, review_probes=21, multi_agent_sync=18, python_analysis=17, code_shape=15, rust_analysis=15 |
...
- source_contract_count: 182
- connected_contract_count: 182
- rendered_contract_count: 21
- omitted_contract_count: 161
...
- `BypassRequest`, `CallerAuthorityPolicy`, `CapabilityGrantState`, `CharterDelivery`, `CheckResult`, `CheckoutInventory`, `CheckoutInventoryClassification`, `CheckoutInventoryRow`
- `CheckpointBudgetShape`, `CheckpointRepairAuthority`, `ClassifierSafetyAttestation`, `ClosureProof`, `CloudFinding`, `CollaborationModeTopology`, `CommitBodyPacketAnchorsGuard`, `CommitMessageRowIdResolvesGuard`
- `CommitReceipt`, `ComposesWith`, `ContextGraphDelta`, `ContextGraphSnapshot`, `ContextGraphSnapshotFreshnessGuard`, `ContinuousImprovementMode`, `ContractRef`, `ControlPlaneReadModel`
- `ControlState`, `CoordinationSnapshot`, `CorrelationContext`, `CustomRoleDefinition`, `DecidedPacketDebtDetector`, `DecisionPacket`, `DevelopRoleAdapterSpec`, `DevelopmentCampaignRoleState`
- `DevelopmentLoopReport`, `DevelopmentModeTopology`, `DogfoodSelfCheckReceipt`, `EvidenceArchiveManifest`, `EvidenceArchivePolicy`, `EvidenceArchiveReceipt`, `ExceptionClass`, `ExceptionLifecycleStatus`
...
- `FindingApplicability`, `FindingBacklog`, `FindingReview`, `GoalProgressReceipt`, `GovernanceCompatibilityClaim`, `GovernedExceptionLifecycle`, `GovernedTransitionModule`, `GroundTruthProbeRunReceipt`
- `IngestionProvenance`, `LifecycleReceipt`, `LocalServiceEndpoint`, `MandatoryIngestBeforeImplementInvariant`, `ManualBypassImportReceipt`, `ModeChangeReceipt`, `OperatorCommandWrapper`, `OperatorDirectivePacket`
...
- `PacketIngestDecision`, `PacketIntentAnchor`, `PacketIntentClassification`, `PacketPlanIngestionMapping`, `PacketReadReceipt`, `PacketSupersessionLink`, `PacketUrgencyClassification`, `PeerAwarenessDecision`
...
- `PushAuthorizationRecord`, `QualityFeedbackSnapshot`, `QueueBypassReasoning`, `RawGitBypassReceipt`, `RelationshipGraph`, `RelaunchQuotaExceeded`, `RemoteCommitPipelineContract`, `RemoteControlAttachmentState`
...
- `RoleCommandEnvelope`, `RoleCreationAction`, `RoleGuard`, `RoleInstructionCard`, `RunRecord`, `RuntimeErrorReceipt`, `RuntimeStateIgnorePostureGuard`, `RuntimeTruthSnapshot`
- `RustAuditReport`, `SecurityReport`, `SessionActivityEntry`, `SessionActivityLog`, `SessionCachePacket`, `SessionLease`, `SessionLivenessReconciler`, `SessionLivenessSignal`
- `SessionOrientationPacket`, `SessionPosture`, `SessionStatusProjection`, `SessionTerminationPolicy`, `SkillCompatibilityValidator`, `SkillLoadReceipt`, `SkillManifest`, `SliceClosureEvent`
- `StaleFindingReceipt`, `StalledQueueFinding`, `SystemPicture`, `TaskCompleteDecision`, `TaskStartedAdrPrecedentLinkingGuard`, `ToggleReceipt`, `TokenOptimizationDogfoodReceipt`, `TransitionContract`
- `TypedAction`, `TypedGateFailure`, `TypedNamespaceCompositionGuard`, `TypedOutputHumanSummary`, `WorkPublicationLedger`, `WorkPublicationLedgerEvent`, `WorkPublicationLedgerHeader`, `WorkflowAdapter`
