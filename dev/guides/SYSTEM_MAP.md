...
|---|---:|---|
| `dev/scripts/devctl` | 1725 | tests=456, commands=407, runtime=243, review_channel=222, governance=70, platform=62, (root)=58, context_graph=38 |
| `dev/scripts/checks` | 399 | (root)=126, package_layout=32, platform_contract_closure=21, python_analysis=17, review_probes=16, code_shape=15, rust_analysis=15, multi_agent_sync=12 |
...
- source_contract_count: 49
- connected_contract_count: 49
