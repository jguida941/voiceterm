...
|---|---:|---|
| `dev/scripts/devctl` | 1965 | tests=495, commands=492, runtime=306, review_channel=266, governance=70, platform=66, (root)=58, context_graph=41 |
| `dev/scripts/checks` | 427 | (root)=135, package_layout=32, platform_contract_closure=21, review_probes=21, python_analysis=17, multi_agent_sync=16, code_shape=15, rust_analysis=15 |
