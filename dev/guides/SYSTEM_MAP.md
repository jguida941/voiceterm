...
|---|---:|---|
| `dev/scripts/devctl` | 1867 | tests=489, commands=435, runtime=291, review_channel=252, governance=70, platform=62, (root)=58, context_graph=41 |
| `dev/scripts/checks` | 424 | (root)=134, package_layout=32, platform_contract_closure=21, review_probes=21, python_analysis=17, multi_agent_sync=16, code_shape=15, rust_analysis=15 |
...
- source_contract_count: 55
- connected_contract_count: 55
