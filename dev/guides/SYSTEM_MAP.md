...
|---|---:|---|
| `dev/scripts/devctl` | 2342 | commands=605, tests=563, runtime=422, review_channel=308, platform=82, governance=74, (root)=62, context_graph=47 |
...
- source_contract_count: 122
- connected_contract_count: 122
- rendered_contract_count: 21
- omitted_contract_count: 101
...
- `RuntimeTruthSnapshot`, `RustAuditReport`, `SecurityReport`, `SessionActivityEntry`, `SessionActivityLog`, `SessionCachePacket`, `SessionLease`, `SessionOrientationPacket`
- `SessionPosture`, `SessionStatusProjection`, `SessionTerminationPolicy`, `SliceClosureEvent`, `SystemPicture`, `TaskCompleteDecision`, `TransitionContract`, `TypedAction`
- `TypedGateFailure`, `WorkPublicationLedger`, `WorkPublicationLedgerEvent`, `WorkPublicationLedgerHeader`, `WorkflowAdapter`, `WorktreeBaseline`
