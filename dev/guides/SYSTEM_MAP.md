...
|---|---:|---|
| `dev/scripts/devctl` | 2350 | commands=607, tests=567, runtime=424, review_channel=308, platform=82, governance=74, (root)=62, context_graph=47 |
| `dev/scripts/checks` | 473 | (root)=149, package_layout=32, platform_contract_closure=22, review_probes=21, multi_agent_sync=18, python_analysis=17, code_shape=15, rust_analysis=15 |
...
- source_contract_count: 125
- connected_contract_count: 125
- rendered_contract_count: 21
- omitted_contract_count: 104
...
- `RemoteControlAttachmentState`, `RemoteControlCollaborationCampaign`, `RemoteControlInvocationReceipt`, `RepoPack`, `ResolutionReceipt`, `ReviewCandidateRecord`, `ReviewChannelCommandFreshness`, `ReviewPacket`
- `ReviewState`, `ReviewTargets`, `ReviewerAuditReceipt`, `ReviewerResponseShape`, `ReviewerRuntimeContract`, `RoleCreationAction`, `RoleGuard`, `RoleInstructionCard`
- `RunRecord`, `RuntimeTruthSnapshot`, `RustAuditReport`, `SecurityReport`, `SessionActivityEntry`, `SessionActivityLog`, `SessionCachePacket`, `SessionLease`
- `SessionLivenessReconciler`, `SessionLivenessSignal`, `SessionOrientationPacket`, `SessionPosture`, `SessionStatusProjection`, `SessionTerminationPolicy`, `SliceClosureEvent`, `SystemPicture`
- `TaskCompleteDecision`, `TransitionContract`, `TypedAction`, `TypedGateFailure`, `WorkPublicationLedger`, `WorkPublicationLedgerEvent`, `WorkPublicationLedgerHeader`, `WorkflowAdapter`
- `WorktreeBaseline`
