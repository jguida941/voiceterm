...
|---|---:|---|
| `dev/scripts/devctl` | 2214 | commands=583, tests=526, runtime=373, review_channel=295, platform=79, governance=74, (root)=62, context_graph=47 |
| `dev/scripts/checks` | 451 | (root)=144, package_layout=32, platform_contract_closure=22, review_probes=21, python_analysis=17, multi_agent_sync=16, code_shape=15, rust_analysis=15 |
...
- source_contract_count: 89
- connected_contract_count: 89
- rendered_contract_count: 13
- omitted_contract_count: 76
...
| `ActionResult` | `governance_runtime` | 14 | `dev.scripts.devctl.runtime.action_contracts:ActionResult` | none |
...
| `FindingReview` | `governance_core` | 21 | `dev.scripts.devctl.governance_review.models:GovernanceReviewInput` | none |
| `FindingBacklog` | `governance_runtime` | 9 | `dev.scripts.devctl.runtime.finding_backlog:FindingBacklog` | none |
| `PlatformFindingIngest` | `governance_runtime` | 10 | `dev.scripts.devctl.runtime.platform_finding_ingest:PlatformFindingIngestResult` | none |
| `PlatformContractRegistryRow` | `governance_core` | 9 | `dev.scripts.devctl.platform.contract_registry_models:ContractRegistryRow` | none |
