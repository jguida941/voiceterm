...
|---|---:|---|
| `dev/scripts/devctl` | 2438 | commands=617, tests=603, runtime=455, review_channel=313, platform=86, governance=74, (root)=63, context_graph=47 |
...
- source_contract_count: 203
- connected_contract_count: 203
- rendered_contract_count: 21
- omitted_contract_count: 182
...
- `DecisionPacket`, `DecisionTtlEvidence`, `DevelopRoleAdapterSpec`, `DevelopmentCampaignRoleState`, `DevelopmentLoopReport`, `DevelopmentModeTopology`, `DogfoodSelfCheckReceipt`, `EvidenceArchiveManifest`
- `EvidenceArchivePolicy`, `EvidenceArchiveReceipt`, `EvidenceArchiveRefResolution`, `ExceptionClass`, `ExceptionLifecycleStatus`, `ExceptionPolicy`, `ExceptionReceipt`, `FailurePacket`
- `FeatureLifecycleProof`, `FeatureProofReceipt`, `FileTopology`, `Finding`, `FindingAffectedScope`, `FindingApplicability`, `FindingBacklog`, `FindingReview`
- `FindingTtlEvidence`, `GoalProgressReceipt`, `GovernanceCompatibilityClaim`, `GovernedExceptionLifecycle`, `GovernedTransitionCheck`, `GovernedTransitionError`, `GovernedTransitionInput`, `GovernedTransitionModule`
- `GroundTruthProbeRunReceipt`, `IllegalTransition`, `IngestionProvenance`, `LifecycleReceipt`, `LocalServiceEndpoint`, `MandatoryIngestBeforeImplementInvariant`, `ManualBypassImportReceipt`, `ModeChangeReceipt`
- `NonTrivialOutputProof`, `NonTrivialOutputProofRemediationFinding`, `NonTrivialOutputProofRemediationFindingLedger`, `OperatorCommandWrapper`, `OperatorDirectivePacket`, `OrphanInventoryReport`, `OrphanReconciliationDecision`, `OrphanSnapshot`
- `OrphanSnapshotStats`, `OrphanSource`, `OrphanSourceClassification`, `OrphanSourceDecision`, `PacketADRReceipt`, `PacketAttentionIngestionDecision`, `PacketBacklogPressure`, `PacketBatchTriage`
...
- `PacketKindTtl`, `PacketPlanIngestionMapping`, `PacketReadReceipt`, `PacketSupersessionLink`, `PacketUrgencyClassification`, `PeerAwarenessDecision`, `PeerAwarenessPolicy`, `PeerHeartbeatEvidence`
- `PlanIntentIngestionReceipt`, `PlanIterationSession`, `PlanRowClosureReceipt`, `PlanRowContractRefsResolveGuard`, `PlanSourceSnapshot`, `PlatformContractRegistry`, `PlatformContractRegistryRow`, `PlatformFindingIngest`
...
- `RuntimeStateIgnorePostureGuard`, `RuntimeTruthSnapshot`, `RustAuditReport`, `SecurityReport`, `SessionActivityEntry`, `SessionActivityLog`, `SessionCachePacket`, `SessionLease`
...
- `SkillManifest`, `SliceClosureEvent`, `StaleFindingReceipt`, `StaleProofRef`, `StalledQueueFinding`, `SystemPicture`, `TaskCompleteDecision`, `TaskProducedTtlEvidence`
- `TaskStartedAdrPrecedentLinkingGuard`, `ToggleReceipt`, `TokenOptimizationDogfoodReceipt`, `TransitionContract`, `TypedAction`, `TypedGateFailure`, `TypedNamespaceCompositionGuard`, `TypedOutputHumanSummary`
- `TypingCompatUtility`, `WorkPublicationLedger`, `WorkPublicationLedgerEvent`, `WorkPublicationLedgerHeader`, `WorkflowAdapter`, `WorkflowStep`, `WorktreeBaseline`
