...
|---|---:|---|
| `dev/scripts/devctl` | 2375 | commands=611, tests=579, runtime=428, review_channel=309, platform=84, governance=74, (root)=63, context_graph=47 |
...
- source_contract_count: 179
- connected_contract_count: 179
- rendered_contract_count: 21
- omitted_contract_count: 158
...
- `ExceptionReceipt`, `FailurePacket`, `FeatureLifecycleProof`, `FileTopology`, `Finding`, `FindingAffectedScope`, `FindingApplicability`, `FindingBacklog`
- `FindingReview`, `GoalProgressReceipt`, `GovernanceCompatibilityClaim`, `GovernedExceptionLifecycle`, `GovernedTransitionModule`, `GroundTruthProbeRunReceipt`, `IngestionProvenance`, `LifecycleReceipt`
- `LocalServiceEndpoint`, `MandatoryIngestBeforeImplementInvariant`, `ManualBypassImportReceipt`, `ModeChangeReceipt`, `OperatorCommandWrapper`, `OperatorDirectivePacket`, `OrphanInventoryReport`, `OrphanReconciliationDecision`
...
- `PacketIntentClassification`, `PacketPlanIngestionMapping`, `PacketReadReceipt`, `PacketSupersessionLink`, `PacketUrgencyClassification`, `PeerAwarenessDecision`, `PeerAwarenessPolicy`, `PeerHeartbeatEvidence`
- `PlanIntentIngestionReceipt`, `PlanIterationSession`, `PlanRowContractRefsResolveGuard`, `PlanSourceSnapshot`, `PlatformContractRegistry`, `PlatformContractRegistryRow`, `PlatformFindingIngest`, `PlatformGuide`
- `PreDecisionComposabilityWindow`, `ProbeAllowlist`, `ProbeReport`, `ProviderAdapter`, `PublicationEpisode`, `PushAuthorizationRecord`, `QualityFeedbackSnapshot`, `QueueBypassReasoning`
- `RawGitBypassReceipt`, `RelationshipGraph`, `RelaunchQuotaExceeded`, `RemoteCommitPipelineContract`, `RemoteControlAttachmentState`, `RemoteControlCollaborationCampaign`, `RemoteControlInvocationReceipt`, `RepairPacket`
- `RepoPack`, `RepoPortabilityCheck`, `ResolutionReceipt`, `ReviewCandidateRecord`, `ReviewChannelCommandFreshness`, `ReviewPacket`, `ReviewState`, `ReviewTargets`
- `ReviewerAuditReceipt`, `ReviewerResponseShape`, `ReviewerRuntimeContract`, `RoleCapability`, `RoleCapabilityRegistry`, `RoleCommandEnvelope`, `RoleCreationAction`, `RoleGuard`
- `RoleInstructionCard`, `RunRecord`, `RuntimeErrorReceipt`, `RuntimeStateIgnorePostureGuard`, `RuntimeTruthSnapshot`, `RustAuditReport`, `SecurityReport`, `SessionActivityEntry`
...
- `SessionTerminationPolicy`, `SkillCompatibilityValidator`, `SkillLoadReceipt`, `SkillManifest`, `SliceClosureEvent`, `StaleFindingReceipt`, `StalledQueueFinding`, `SystemPicture`
- `TaskCompleteDecision`, `TaskStartedAdrPrecedentLinkingGuard`, `ToggleReceipt`, `TokenOptimizationDogfoodReceipt`, `TransitionContract`, `TypedAction`, `TypedGateFailure`, `TypedNamespaceCompositionGuard`
- `TypedOutputHumanSummary`, `WorkPublicationLedger`, `WorkPublicationLedgerEvent`, `WorkPublicationLedgerHeader`, `WorkflowAdapter`, `WorkflowStep`, `WorktreeBaseline`
