...
|---|---:|---|
| `dev/scripts/devctl` | 2356 | commands=608, tests=569, runtime=426, review_channel=308, platform=83, governance=74, (root)=62, context_graph=47 |
| `dev/scripts/checks` | 485 | (root)=151, package_layout=32, platform_contract_closure=22, review_probes=21, multi_agent_sync=18, python_analysis=17, code_shape=15, rust_analysis=15 |
...
- source_contract_count: 156
- connected_contract_count: 156
- rendered_contract_count: 21
- omitted_contract_count: 135
...
- `AcceptAllOrphansAction`, `AcceptAllOrphansReceipt`, `ActionResult`, `ActorAuthorityState`, `AgentDispatchRouter`, `AgentLoopBilateralProtocol`, `AgentMindConsumptionReceipt`, `AgentRelaunchTrigger`
- `AgentResumeReceipt`, `AgentSessionContinuation`, `AgentSessionOutcome`, `AgentWorkflowSpec`, `ArtifactStore`, `AssistantGuideMode`, `AutoModeState`, `AutoRepairReceipt`
- `BaselineAuthorityInventoryReceipt`, `BypassEvaluation`, `BypassExpiry`, `BypassLifecycle`, `BypassReceipt`, `BypassRequest`, `CallerAuthorityPolicy`, `CapabilityGrantState`
- `CharterDelivery`, `CheckResult`, `CheckoutInventory`, `CheckoutInventoryClassification`, `CheckoutInventoryRow`, `CheckpointBudgetShape`, `CheckpointRepairAuthority`, `ClassifierSafetyAttestation`
- `ClosureProof`, `CollaborationModeTopology`, `CommitReceipt`, `ComposesWith`, `ContextGraphDelta`, `ContextGraphSnapshot`, `ContinuousImprovementMode`, `ContractRef`
- `ControlPlaneReadModel`, `ControlState`, `CoordinationSnapshot`, `CorrelationContext`, `CustomRoleDefinition`, `DecisionPacket`, `DevelopRoleAdapterSpec`, `DevelopmentCampaignRoleState`
...
- `ExceptionPolicy`, `ExceptionReceipt`, `FailurePacket`, `FeatureLifecycleProof`, `FileTopology`, `Finding`, `FindingBacklog`, `FindingReview`
- `GoalProgressReceipt`, `GovernanceCompatibilityClaim`, `GovernedExceptionLifecycle`, `GovernedTransitionModule`, `GroundTruthProbeRunReceipt`, `LifecycleReceipt`, `LocalServiceEndpoint`, `MandatoryIngestBeforeImplementInvariant`
- `ManualBypassImportReceipt`, `ModeChangeReceipt`, `OrphanInventoryReport`, `OrphanReconciliationDecision`, `OrphanSnapshot`, `OrphanSnapshotStats`, `OrphanSource`, `OrphanSourceClassification`
- `OrphanSourceDecision`, `PacketADRReceipt`, `PacketAttentionIngestionDecision`, `PacketBacklogPressure`, `PacketDebtRemediationReport`, `PacketDurableIngestionReceipt`, `PacketGuardErrorDetail`, `PacketIngestDecision`
...
- `PeerHeartbeatEvidence`, `PlanIntentIngestionReceipt`, `PlanIterationSession`, `PlanSourceSnapshot`, `PlatformContractRegistry`, `PlatformContractRegistryRow`, `PlatformFindingIngest`, `PlatformGuide`
...
- `ReviewerResponseShape`, `ReviewerRuntimeContract`, `RoleCapability`, `RoleCapabilityRegistry`, `RoleCreationAction`, `RoleGuard`, `RoleInstructionCard`, `RunRecord`
...
- `SkillManifest`, `SliceClosureEvent`, `StalledQueueFinding`, `SystemPicture`, `TaskCompleteDecision`, `ToggleReceipt`, `TransitionContract`, `TypedAction`
