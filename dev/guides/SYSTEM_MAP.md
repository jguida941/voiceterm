...
|---|---:|---|
| `dev/scripts/devctl` | 2322 | commands=603, tests=554, runtime=417, review_channel=308, platform=81, governance=74, (root)=62, context_graph=47 |
| `dev/scripts/checks` | 458 | (root)=146, package_layout=32, platform_contract_closure=22, review_probes=21, multi_agent_sync=18, python_analysis=17, code_shape=15, rust_analysis=15 |
...
- source_contract_count: 118
- connected_contract_count: 118
...
| `RunRecord` | `governance_runtime` | 9 | `dev.scripts.devctl.runtime.action_contracts:RunRecord` | none |
