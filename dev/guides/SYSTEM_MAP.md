...
|---|---:|---|
| `dev/scripts/devctl` | 2360 | commands=608, tests=572, runtime=426, review_channel=308, platform=83, governance=74, (root)=62, context_graph=47 |
| `dev/scripts/checks` | 495 | (root)=157, package_layout=32, platform_contract_closure=22, review_probes=21, multi_agent_sync=18, python_analysis=17, code_shape=15, rust_analysis=15 |
...
- source_contract_count: 166
- connected_contract_count: 166
- rendered_contract_count: 21
- omitted_contract_count: 145
...
- `TransitionContract`, `TypedAction`, `TypedGateFailure`, `TypedOutputHumanSummary`, `WorkPublicationLedger`, `WorkPublicationLedgerEvent`, `WorkPublicationLedgerHeader`, `WorkflowAdapter`
