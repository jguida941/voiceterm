...
|---|---:|---|
| `dev/scripts/devctl` | 2086 | commands=535, tests=511, runtime=338, review_channel=270, governance=74, platform=74, (root)=62, context_graph=47 |
| `dev/scripts/checks` | 437 | (root)=138, package_layout=32, platform_contract_closure=21, review_probes=21, python_analysis=17, multi_agent_sync=16, code_shape=15, rust_analysis=15 |
...
| `codex_boot_card` | `instruction_boot_card` | `CODEX.md` | local-only |
...
- source_contract_count: 81
- connected_contract_count: 81
