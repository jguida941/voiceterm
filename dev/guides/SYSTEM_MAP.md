...
|---|---:|---|
| `dev/scripts/devctl` | 2376 | commands=611, tests=579, runtime=429, review_channel=309, platform=84, governance=74, (root)=63, context_graph=47 |
| `dev/scripts/checks` | 499 | (root)=160, package_layout=32, platform_contract_closure=22, review_probes=21, multi_agent_sync=18, python_analysis=17, code_shape=15, rust_analysis=15 |
