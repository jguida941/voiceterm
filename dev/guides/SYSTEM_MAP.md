...
|---|---:|---|
| `dev/scripts/devctl` | 2479 | commands=623, tests=620, runtime=470, review_channel=316, platform=86, governance=74, (root)=63, context_graph=47 |
| `dev/scripts/checks` | 537 | (root)=174, package_layout=32, platform_contract_closure=22, review_probes=21, multi_agent_sync=18, python_analysis=17, code_shape=15, rust_analysis=15 |
...
- `CommandOutputReceipt`, `CommitBodyPacketAnchorsGuard`, `CommitMessageRowIdResolvesGuard`, `CommitReceipt`, `ComposesWith`, `ContextGraphDelta`, `ContextGraphSnapshot`, `ContextGraphSnapshotFreshnessGuard`
- `ContinuousImprovementMode`, `ContractRef`, `ContractRegistryCompositeKeyUniqueness`, `ContractRegistryCompositeKeyUniquenessCommand`, `ControlPlaneReadModel`, `ControlState`, `CoordinationSnapshot`, `CorrelationContext`
- `CustomRoleDefinition`, `DecidedPacketDebtDetector`, `DecisionPacket`, `DecisionTtlEvidence`, `DevelopRoleAdapterSpec`, `DevelopmentCampaignRoleState`, `DevelopmentLoopReport`, `DevelopmentModeTopology`
- `DogfoodSelfCheckReceipt`, `DurableSchemaPolicy`, `EvidenceArchiveManifest`, `EvidenceArchivePolicy`, `EvidenceArchiveReceipt`, `EvidenceArchiveRefResolution`, `ExceptionClass`, `ExceptionLifecycleStatus`
- `ExceptionPolicy`, `ExceptionReceipt`, `FailurePacket`, `FeatureLifecycleProof`, `FeatureProofReceipt`, `FileTopology`, `Finding`, `FindingAffectedScope`
- `FindingApplicability`, `FindingBacklog`, `FindingReview`, `FindingTtlEvidence`, `GoalProgressReceipt`, `GovernanceCompatibilityClaim`, `GovernedExceptionLifecycle`, `GovernedTransitionCheck`
- `GovernedTransitionError`, `GovernedTransitionInput`, `GovernedTransitionModule`, `GroundTruthProbeRunReceipt`, `IllegalTransition`, `IngestionProvenance`, `LifecycleReceipt`, `LocalServiceEndpoint`
- `MandatoryIngestBeforeImplementInvariant`, `ManualBypassImportReceipt`, `ModeChangeReceipt`, `NonTrivialOutputProof`, `NonTrivialOutputProofRemediationFinding`, `NonTrivialOutputProofRemediationFindingLedger`, `OperatorCommandWrapper`, `OperatorDirectivePacket`
...
- `PacketAttentionIngestionDecision`, `PacketBacklogPressure`, `PacketBatchTriage`, `PacketBatchTriageRow`, `PacketDebtRemediationReport`, `PacketDebtRemediationRow`, `PacketDurableIngestionReceipt`, `PacketGuardErrorDetail`
- `PacketIngestDecision`, `PacketIntentAnchor`, `PacketIntentClassification`, `PacketKindTtl`, `PacketPlanIngestionMapping`, `PacketReadReceipt`, `PacketSupersessionLink`, `PacketUrgencyClassification`
- `PeerAwarenessDecision`, `PeerAwarenessPolicy`, `PeerHeartbeatEvidence`, `PlanIntentIngestionReceipt`, `PlanIterationSession`, `PlanRowClosureReceipt`, `PlanRowContractRefsResolveGuard`, `PlanSourceSnapshot`
- `PlatformContractRegistry`, `PlatformContractRegistryRow`, `PlatformFindingIngest`, `PlatformGuide`, `PreDecisionComposabilityWindow`, `ProbeAllowlist`, `ProbeReport`, `ProviderAdapter`
- `PublicationEpisode`, `PushAuthorizationRecord`, `QualityFeedbackSnapshot`, `QuestionTtlEvidence`, `QueueBypassReasoning`, `RawGitBypassReceipt`, `RelationshipGraph`, `RelaunchQuotaExceeded`
- `RemoteCommitPipelineContract`, `RemoteControlAttachmentState`, `RemoteControlCollaborationCampaign`, `RemoteControlInvocationReceipt`, `RepairPacket`, `RepoPack`, `RepoPortabilityCheck`, `ResolutionReceipt`
- `ReviewCandidateRecord`, `ReviewChannelCommandFreshness`, `ReviewPacket`, `ReviewState`, `ReviewTargets`, `ReviewerAuditReceipt`, `ReviewerResponseShape`, `ReviewerRuntimeContract`
- `RoleCapability`, `RoleCapabilityRegistry`, `RoleCommandEnvelope`, `RoleCreationAction`, `RoleGuard`, `RoleInstructionCard`, `RoleReviewAssignmentLifecycle`, `RoleReviewReceipt`
- `RoleReviewTimeout`, `RunRecord`, `RuntimeErrorReceipt`, `RuntimeStateIgnorePostureGuard`, `RuntimeTruthSnapshot`, `RustAuditReport`, `SchemaMigrationSpine`, `SecurityReport`
- `SessionActivityEntry`, `SessionActivityLog`, `SessionCachePacket`, `SessionLease`, `SessionLivenessReconciler`, `SessionLivenessSignal`, `SessionOrientationPacket`, `SessionPosture`
- `SessionStatusProjection`, `SessionTerminationPolicy`, `SkillCompatibilityValidator`, `SkillLoadReceipt`, `SkillManifest`, `SliceClosureEvent`, `StaleFindingReceipt`, `StaleProofRef`
- `StalledQueueFinding`, `SystemMapSnapshot`, `SystemPicture`, `TagReceipt`, `TaskCompleteDecision`, `TaskProducedTtlEvidence`, `TaskStartedAdrPrecedentLinkingGuard`, `ToggleReceipt`
- `TokenOptimizationDogfoodReceipt`, `TransitionContract`, `TypedAction`, `TypedGateFailure`, `TypedNamespaceCompositionGuard`, `TypedOutputHumanSummary`, `TypingCompatUtility`, `WorkPublicationLedger`
- `WorkPublicationLedgerEvent`, `WorkPublicationLedgerHeader`, `WorkflowAdapter`, `WorkflowStep`, `WorktreeBaseline`
