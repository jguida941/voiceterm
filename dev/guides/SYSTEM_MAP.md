...
|---|---:|---|
| `dev/scripts/devctl` | 2393 | commands=612, tests=588, runtime=433, review_channel=311, platform=85, governance=74, (root)=63, context_graph=47 |
| `dev/scripts/checks` | 506 | (root)=164, package_layout=32, platform_contract_closure=22, review_probes=21, multi_agent_sync=18, python_analysis=17, code_shape=15, rust_analysis=15 |
...
- source_contract_count: 194
- connected_contract_count: 194
- rendered_contract_count: 21
- omitted_contract_count: 173
...
- `GoalProgressReceipt`, `GovernanceCompatibilityClaim`, `GovernedExceptionLifecycle`, `GovernedTransitionModule`, `GroundTruthProbeRunReceipt`, `IngestionProvenance`, `LifecycleReceipt`, `LocalServiceEndpoint`
...
- `RoleCapability`, `RoleCapabilityRegistry`, `RoleCommandEnvelope`, `RoleCreationAction`, `RoleGuard`, `RoleInstructionCard`, `RunRecord`, `RuntimeErrorReceipt`
...
- `SkillManifest`, `SliceClosureEvent`, `StaleFindingReceipt`, `StalledQueueFinding`, `SystemPicture`, `TaskCompleteDecision`, `TaskProducedTtlEvidence`, `TaskStartedAdrPrecedentLinkingGuard`
