...
|---|---:|---|
| `dev/scripts/devctl` | 1661 | tests=446, commands=393, runtime=225, review_channel=205, governance=68, platform=61, (root)=58, context_graph=38 |
| `dev/scripts/checks` | 393 | (root)=124, package_layout=32, platform_contract_closure=21, python_analysis=17, review_probes=16, code_shape=15, rust_analysis=15, multi_agent_sync=12 |
...
- source_contract_count: 46
- connected_contract_count: 46
