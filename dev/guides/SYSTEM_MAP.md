...
|---|---:|---|
| `dev/scripts/devctl` | 1772 | tests=470, commands=417, runtime=255, review_channel=230, governance=70, platform=62, (root)=58, context_graph=41 |
| `dev/scripts/checks` | 401 | (root)=127, package_layout=32, platform_contract_closure=21, python_analysis=17, review_probes=17, code_shape=15, rust_analysis=15, multi_agent_sync=12 |
...
- source_contract_count: 52
- connected_contract_count: 52
