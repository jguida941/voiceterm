...
|---|---:|---|
| `dev/scripts/devctl` | 2228 | commands=590, tests=528, runtime=375, review_channel=298, platform=79, governance=74, (root)=62, context_graph=47 |
| `dev/scripts/checks` | 452 | (root)=145, package_layout=32, platform_contract_closure=22, review_probes=21, python_analysis=17, multi_agent_sync=16, code_shape=15, rust_analysis=15 |
