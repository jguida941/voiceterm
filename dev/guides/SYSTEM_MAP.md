...
|---|---:|---|
| `dev/scripts/devctl` | 1611 | tests=430, commands=373, runtime=220, review_channel=201, governance=67, (root)=58, platform=57, context_graph=38 |
| `dev/scripts/checks` | 382 | (root)=122, package_layout=32, platform_contract_closure=18, python_analysis=17, review_probes=16, code_shape=15, rust_analysis=15, multi_agent_sync=12 |
