...
|---|---:|---|
| `dev/scripts/devctl` | 2442 | commands=617, tests=605, runtime=457, review_channel=313, platform=86, governance=74, (root)=63, context_graph=47 |
| `dev/scripts/checks` | 513 | (root)=165, package_layout=32, platform_contract_closure=22, review_probes=21, multi_agent_sync=18, python_analysis=17, code_shape=15, rust_analysis=15 |
...
- source_contract_count: 208
- connected_contract_count: 208
- rendered_contract_count: 21
- omitted_contract_count: 187
...
- `CommitBodyPacketAnchorsGuard`, `CommitMessageRowIdResolvesGuard`, `CommitReceipt`, `ComposesWith`, `ContextGraphDelta`, `ContextGraphSnapshot`, `ContextGraphSnapshotFreshnessGuard`, `ContinuousImprovementMode`
- `ContractRef`, `ContractRegistryCompositeKeyUniqueness`, `ContractRegistryCompositeKeyUniquenessCommand`, `ControlPlaneReadModel`, `ControlState`, `CoordinationSnapshot`, `CorrelationContext`, `CustomRoleDefinition`
- `DecidedPacketDebtDetector`, `DecisionPacket`, `DecisionTtlEvidence`, `DevelopRoleAdapterSpec`, `DevelopmentCampaignRoleState`, `DevelopmentLoopReport`, `DevelopmentModeTopology`, `DogfoodSelfCheckReceipt`
...
- `ExceptionReceipt`, `FailurePacket`, `FeatureLifecycleProof`, `FeatureProofReceipt`, `FileTopology`, `Finding`, `FindingAffectedScope`, `FindingApplicability`
- `FindingBacklog`, `FindingReview`, `FindingTtlEvidence`, `GoalProgressReceipt`, `GovernanceCompatibilityClaim`, `GovernedExceptionLifecycle`, `GovernedTransitionCheck`, `GovernedTransitionError`
- `GovernedTransitionInput`, `GovernedTransitionModule`, `GroundTruthProbeRunReceipt`, `IllegalTransition`, `IngestionProvenance`, `LifecycleReceipt`, `LocalServiceEndpoint`, `MandatoryIngestBeforeImplementInvariant`
- `ManualBypassImportReceipt`, `ModeChangeReceipt`, `NonTrivialOutputProof`, `NonTrivialOutputProofRemediationFinding`, `NonTrivialOutputProofRemediationFindingLedger`, `OperatorCommandWrapper`, `OperatorDirectivePacket`, `OrphanInventoryReport`
- `OrphanReconciliationDecision`, `OrphanSnapshot`, `OrphanSnapshotStats`, `OrphanSource`, `OrphanSourceClassification`, `OrphanSourceDecision`, `PacketADRReceipt`, `PacketAttentionIngestionDecision`
- `PacketBacklogPressure`, `PacketBatchTriage`, `PacketBatchTriageRow`, `PacketDebtRemediationReport`, `PacketDebtRemediationRow`, `PacketDurableIngestionReceipt`, `PacketGuardErrorDetail`, `PacketIngestDecision`
- `PacketIntentAnchor`, `PacketIntentClassification`, `PacketKindTtl`, `PacketPlanIngestionMapping`, `PacketReadReceipt`, `PacketSupersessionLink`, `PacketUrgencyClassification`, `PeerAwarenessDecision`
- `PeerAwarenessPolicy`, `PeerHeartbeatEvidence`, `PlanIntentIngestionReceipt`, `PlanIterationSession`, `PlanRowClosureReceipt`, `PlanRowContractRefsResolveGuard`, `PlanSourceSnapshot`, `PlatformContractRegistry`
