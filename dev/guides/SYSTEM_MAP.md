...
|---|---:|---|
| `dev/scripts/devctl` | 2440 | commands=617, tests=604, runtime=456, review_channel=313, platform=86, governance=74, (root)=63, context_graph=47 |
...
- source_contract_count: 206
- connected_contract_count: 206
- rendered_contract_count: 21
- omitted_contract_count: 185
...
- `AutoModeState`, `AutoRepairReceipt`, `BaselineAuthorityInventoryReceipt`, `BridgeSeparationGuard`, `BypassEvaluation`, `BypassExpiry`, `BypassLifecycle`, `BypassReceipt`
- `BypassRequest`, `CallerAuthorityPolicy`, `CapabilityGrantState`, `CharterDelivery`, `CheckNonTrivialOutputProofCommand`, `CheckResult`, `CheckoutInventory`, `CheckoutInventoryClassification`
- `CheckoutInventoryRow`, `CheckpointBudgetShape`, `CheckpointRepairAuthority`, `ClassifierSafetyAttestation`, `ClosureProof`, `CloudFinding`, `CollaborationModeTopology`, `CommitBodyPacketAnchorsGuard`
- `CommitMessageRowIdResolvesGuard`, `CommitReceipt`, `ComposesWith`, `ContextGraphDelta`, `ContextGraphSnapshot`, `ContextGraphSnapshotFreshnessGuard`, `ContinuousImprovementMode`, `ContractRef`
- `ContractRegistryCompositeKeyUniqueness`, `ContractRegistryCompositeKeyUniquenessCommand`, `ControlPlaneReadModel`, `ControlState`, `CoordinationSnapshot`, `CorrelationContext`, `CustomRoleDefinition`, `DecidedPacketDebtDetector`
- `DecisionPacket`, `DecisionTtlEvidence`, `DevelopRoleAdapterSpec`, `DevelopmentCampaignRoleState`, `DevelopmentLoopReport`, `DevelopmentModeTopology`, `DogfoodSelfCheckReceipt`, `DurableSchemaPolicy`
- `EvidenceArchiveManifest`, `EvidenceArchivePolicy`, `EvidenceArchiveReceipt`, `EvidenceArchiveRefResolution`, `ExceptionClass`, `ExceptionLifecycleStatus`, `ExceptionPolicy`, `ExceptionReceipt`
- `FailurePacket`, `FeatureLifecycleProof`, `FeatureProofReceipt`, `FileTopology`, `Finding`, `FindingAffectedScope`, `FindingApplicability`, `FindingBacklog`
- `FindingReview`, `FindingTtlEvidence`, `GoalProgressReceipt`, `GovernanceCompatibilityClaim`, `GovernedExceptionLifecycle`, `GovernedTransitionCheck`, `GovernedTransitionError`, `GovernedTransitionInput`
- `GovernedTransitionModule`, `GroundTruthProbeRunReceipt`, `IllegalTransition`, `IngestionProvenance`, `LifecycleReceipt`, `LocalServiceEndpoint`, `MandatoryIngestBeforeImplementInvariant`, `ManualBypassImportReceipt`
- `ModeChangeReceipt`, `NonTrivialOutputProof`, `NonTrivialOutputProofRemediationFinding`, `NonTrivialOutputProofRemediationFindingLedger`, `OperatorCommandWrapper`, `OperatorDirectivePacket`, `OrphanInventoryReport`, `OrphanReconciliationDecision`
- `OrphanSnapshot`, `OrphanSnapshotStats`, `OrphanSource`, `OrphanSourceClassification`, `OrphanSourceDecision`, `PacketADRReceipt`, `PacketAttentionIngestionDecision`, `PacketBacklogPressure`
- `PacketBatchTriage`, `PacketBatchTriageRow`, `PacketDebtRemediationReport`, `PacketDebtRemediationRow`, `PacketDurableIngestionReceipt`, `PacketGuardErrorDetail`, `PacketIngestDecision`, `PacketIntentAnchor`
- `PacketIntentClassification`, `PacketKindTtl`, `PacketPlanIngestionMapping`, `PacketReadReceipt`, `PacketSupersessionLink`, `PacketUrgencyClassification`, `PeerAwarenessDecision`, `PeerAwarenessPolicy`
- `PeerHeartbeatEvidence`, `PlanIntentIngestionReceipt`, `PlanIterationSession`, `PlanRowClosureReceipt`, `PlanRowContractRefsResolveGuard`, `PlanSourceSnapshot`, `PlatformContractRegistry`, `PlatformContractRegistryRow`
- `PlatformFindingIngest`, `PlatformGuide`, `PreDecisionComposabilityWindow`, `ProbeAllowlist`, `ProbeReport`, `ProviderAdapter`, `PublicationEpisode`, `PushAuthorizationRecord`
- `QualityFeedbackSnapshot`, `QuestionTtlEvidence`, `QueueBypassReasoning`, `RawGitBypassReceipt`, `RelationshipGraph`, `RelaunchQuotaExceeded`, `RemoteCommitPipelineContract`, `RemoteControlAttachmentState`
- `RemoteControlCollaborationCampaign`, `RemoteControlInvocationReceipt`, `RepairPacket`, `RepoPack`, `RepoPortabilityCheck`, `ResolutionReceipt`, `ReviewCandidateRecord`, `ReviewChannelCommandFreshness`
- `ReviewPacket`, `ReviewState`, `ReviewTargets`, `ReviewerAuditReceipt`, `ReviewerResponseShape`, `ReviewerRuntimeContract`, `RoleCapability`, `RoleCapabilityRegistry`
- `RoleCommandEnvelope`, `RoleCreationAction`, `RoleGuard`, `RoleInstructionCard`, `RoleReviewAssignmentLifecycle`, `RoleReviewReceipt`, `RoleReviewTimeout`, `RunRecord`
- `RuntimeErrorReceipt`, `RuntimeStateIgnorePostureGuard`, `RuntimeTruthSnapshot`, `RustAuditReport`, `SchemaMigrationSpine`, `SecurityReport`, `SessionActivityEntry`, `SessionActivityLog`
- `SessionCachePacket`, `SessionLease`, `SessionLivenessReconciler`, `SessionLivenessSignal`, `SessionOrientationPacket`, `SessionPosture`, `SessionStatusProjection`, `SessionTerminationPolicy`
- `SkillCompatibilityValidator`, `SkillLoadReceipt`, `SkillManifest`, `SliceClosureEvent`, `StaleFindingReceipt`, `StaleProofRef`, `StalledQueueFinding`, `SystemMapSnapshot`
- `SystemPicture`, `TaskCompleteDecision`, `TaskProducedTtlEvidence`, `TaskStartedAdrPrecedentLinkingGuard`, `ToggleReceipt`, `TokenOptimizationDogfoodReceipt`, `TransitionContract`, `TypedAction`
