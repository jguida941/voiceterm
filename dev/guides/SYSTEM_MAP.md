...
| `dev/scripts/checks` | 488 | (root)=152, package_layout=32, platform_contract_closure=22, review_probes=21, multi_agent_sync=18, python_analysis=17, code_shape=15, rust_analysis=15 |
...
- source_contract_count: 161
- connected_contract_count: 161
- rendered_contract_count: 21
- omitted_contract_count: 140
...
- `AcceptAllOrphansAction`, `AcceptAllOrphansReceipt`, `ActionResult`, `ActorAuthorityState`, `AffectedTestSelection`, `AgentDispatchRouter`, `AgentLoopBilateralProtocol`, `AgentMindConsumptionReceipt`
- `AgentRelaunchTrigger`, `AgentResumeReceipt`, `AgentSessionContinuation`, `AgentSessionOutcome`, `AgentWorkflowSpec`, `ArtifactStore`, `AssistantGuideMode`, `AutoModeState`
- `AutoRepairReceipt`, `BaselineAuthorityInventoryReceipt`, `BridgeSeparationGuard`, `BypassEvaluation`, `BypassExpiry`, `BypassLifecycle`, `BypassReceipt`, `BypassRequest`
- `CallerAuthorityPolicy`, `CapabilityGrantState`, `CharterDelivery`, `CheckResult`, `CheckoutInventory`, `CheckoutInventoryClassification`, `CheckoutInventoryRow`, `CheckpointBudgetShape`
- `CheckpointRepairAuthority`, `ClassifierSafetyAttestation`, `ClosureProof`, `CollaborationModeTopology`, `CommitReceipt`, `ComposesWith`, `ContextGraphDelta`, `ContextGraphSnapshot`
- `ContinuousImprovementMode`, `ContractRef`, `ControlPlaneReadModel`, `ControlState`, `CoordinationSnapshot`, `CorrelationContext`, `CustomRoleDefinition`, `DecisionPacket`
- `DevelopRoleAdapterSpec`, `DevelopmentCampaignRoleState`, `DevelopmentLoopReport`, `DevelopmentModeTopology`, `DogfoodSelfCheckReceipt`, `EvidenceArchiveManifest`, `EvidenceArchivePolicy`, `EvidenceArchiveReceipt`
- `ExceptionClass`, `ExceptionLifecycleStatus`, `ExceptionPolicy`, `ExceptionReceipt`, `FailurePacket`, `FeatureLifecycleProof`, `FileTopology`, `Finding`
...
- `LifecycleReceipt`, `LocalServiceEndpoint`, `MandatoryIngestBeforeImplementInvariant`, `ManualBypassImportReceipt`, `ModeChangeReceipt`, `OrphanInventoryReport`, `OrphanReconciliationDecision`, `OrphanSnapshot`
- `OrphanSnapshotStats`, `OrphanSource`, `OrphanSourceClassification`, `OrphanSourceDecision`, `PacketADRReceipt`, `PacketAttentionIngestionDecision`, `PacketBacklogPressure`, `PacketDebtRemediationReport`
- `PacketDurableIngestionReceipt`, `PacketGuardErrorDetail`, `PacketIngestDecision`, `PacketIntentAnchor`, `PacketIntentClassification`, `PacketPlanIngestionMapping`, `PacketReadReceipt`, `PacketSupersessionLink`
- `PacketUrgencyClassification`, `PeerAwarenessDecision`, `PeerAwarenessPolicy`, `PeerHeartbeatEvidence`, `PlanIntentIngestionReceipt`, `PlanIterationSession`, `PlanSourceSnapshot`, `PlatformContractRegistry`
...
- `RemoteControlCollaborationCampaign`, `RemoteControlInvocationReceipt`, `RepoPack`, `RepoPortabilityCheck`, `ResolutionReceipt`, `ReviewCandidateRecord`, `ReviewChannelCommandFreshness`, `ReviewPacket`
...
- `RoleCreationAction`, `RoleGuard`, `RoleInstructionCard`, `RunRecord`, `RuntimeErrorReceipt`, `RuntimeTruthSnapshot`, `RustAuditReport`, `SecurityReport`
...
- `SessionStatusProjection`, `SessionTerminationPolicy`, `SkillCompatibilityValidator`, `SkillLoadReceipt`, `SkillManifest`, `SliceClosureEvent`, `StalledQueueFinding`, `SystemPicture`
- `TaskCompleteDecision`, `ToggleReceipt`, `TokenOptimizationDogfoodReceipt`, `TransitionContract`, `TypedAction`, `TypedGateFailure`, `TypedOutputHumanSummary`, `WorkPublicationLedger`
