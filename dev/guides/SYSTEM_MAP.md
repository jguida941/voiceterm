...
|---|---:|---|
| `dev/scripts/devctl` | 2346 | commands=606, tests=565, runtime=423, review_channel=308, platform=82, governance=74, (root)=62, context_graph=47 |
...
- source_contract_count: 124
- connected_contract_count: 124
- rendered_contract_count: 21
- omitted_contract_count: 103
...
- `ProbeReport`, `ProviderAdapter`, `PublicationEpisode`, `PushAuthorizationRecord`, `QualityFeedbackSnapshot`, `RelaunchQuotaExceeded`, `RemoteCommitPipelineContract`, `RemoteControlAttachmentState`
- `RemoteControlCollaborationCampaign`, `RemoteControlInvocationReceipt`, `RepoPack`, `ResolutionReceipt`, `ReviewCandidateRecord`, `ReviewChannelCommandFreshness`, `ReviewPacket`, `ReviewState`
- `ReviewTargets`, `ReviewerAuditReceipt`, `ReviewerResponseShape`, `ReviewerRuntimeContract`, `RoleCreationAction`, `RoleGuard`, `RoleInstructionCard`, `RunRecord`
...
- `SessionLivenessSignal`, `SessionOrientationPacket`, `SessionPosture`, `SessionStatusProjection`, `SessionTerminationPolicy`, `SliceClosureEvent`, `SystemPicture`, `TaskCompleteDecision`
- `TransitionContract`, `TypedAction`, `TypedGateFailure`, `WorkPublicationLedger`, `WorkPublicationLedgerEvent`, `WorkPublicationLedgerHeader`, `WorkflowAdapter`, `WorktreeBaseline`
