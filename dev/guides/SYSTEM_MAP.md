...
|---|---:|---|
| `dev/scripts/devctl` | 1687 | tests=449, commands=401, runtime=232, review_channel=212, governance=68, platform=61, (root)=58, context_graph=38 |
| `dev/scripts/checks` | 395 | (root)=124, package_layout=32, platform_contract_closure=21, python_analysis=17, review_probes=16, code_shape=15, rust_analysis=15, multi_agent_sync=12 |
...
- source_contract_count: 47
- connected_contract_count: 47
