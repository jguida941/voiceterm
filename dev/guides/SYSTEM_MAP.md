...
|---|---:|---|
| `dev/scripts/devctl` | 2420 | commands=616, tests=593, runtime=449, review_channel=312, platform=86, governance=74, (root)=63, context_graph=47 |
...
- source_contract_count: 202
- connected_contract_count: 202
- rendered_contract_count: 21
- omitted_contract_count: 181
...
| `RoleGuard` | `governance_runtime` | 7 | `dev.scripts.devctl.runtime.role_customization:RoleGuard` | none |
...
- `EvidenceArchivePolicy`, `EvidenceArchiveReceipt`, `ExceptionClass`, `ExceptionLifecycleStatus`, `ExceptionPolicy`, `ExceptionReceipt`, `FailurePacket`, `FeatureLifecycleProof`
- `FeatureProofReceipt`, `FileTopology`, `Finding`, `FindingAffectedScope`, `FindingApplicability`, `FindingBacklog`, `FindingReview`, `FindingTtlEvidence`
...
- `PlanIterationSession`, `PlanRowClosureReceipt`, `PlanRowContractRefsResolveGuard`, `PlanSourceSnapshot`, `PlatformContractRegistry`, `PlatformContractRegistryRow`, `PlatformFindingIngest`, `PlatformGuide`
...
- `RuntimeTruthSnapshot`, `RustAuditReport`, `SecurityReport`, `SessionActivityEntry`, `SessionActivityLog`, `SessionCachePacket`, `SessionLease`, `SessionLivenessReconciler`
- `SessionLivenessSignal`, `SessionOrientationPacket`, `SessionPosture`, `SessionStatusProjection`, `SessionTerminationPolicy`, `SkillCompatibilityValidator`, `SkillLoadReceipt`, `SkillManifest`
- `SliceClosureEvent`, `StaleFindingReceipt`, `StaleProofRef`, `StalledQueueFinding`, `SystemPicture`, `TaskCompleteDecision`, `TaskProducedTtlEvidence`, `TaskStartedAdrPrecedentLinkingGuard`
- `ToggleReceipt`, `TokenOptimizationDogfoodReceipt`, `TransitionContract`, `TypedAction`, `TypedGateFailure`, `TypedNamespaceCompositionGuard`, `TypedOutputHumanSummary`, `TypingCompatUtility`
