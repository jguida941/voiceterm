...
|---|---:|---|
| `dev/scripts/devctl` | 2369 | commands=610, tests=575, runtime=428, review_channel=308, platform=84, governance=74, (root)=63, context_graph=47 |
...
- source_contract_count: 174
- connected_contract_count: 174
- rendered_contract_count: 21
- omitted_contract_count: 153
...
- `CoordinationSnapshot`, `CorrelationContext`, `CustomRoleDefinition`, `DecisionPacket`, `DevelopRoleAdapterSpec`, `DevelopmentCampaignRoleState`, `DevelopmentLoopReport`, `DevelopmentModeTopology`
- `DogfoodSelfCheckReceipt`, `EvidenceArchiveManifest`, `EvidenceArchivePolicy`, `EvidenceArchiveReceipt`, `ExceptionClass`, `ExceptionLifecycleStatus`, `ExceptionPolicy`, `ExceptionReceipt`
- `FailurePacket`, `FeatureLifecycleProof`, `FileTopology`, `Finding`, `FindingAffectedScope`, `FindingApplicability`, `FindingBacklog`, `FindingReview`
...
- `MandatoryIngestBeforeImplementInvariant`, `ManualBypassImportReceipt`, `ModeChangeReceipt`, `OperatorCommandWrapper`, `OrphanInventoryReport`, `OrphanReconciliationDecision`, `OrphanSnapshot`, `OrphanSnapshotStats`
- `OrphanSource`, `OrphanSourceClassification`, `OrphanSourceDecision`, `PacketADRReceipt`, `PacketAttentionIngestionDecision`, `PacketBacklogPressure`, `PacketDebtRemediationReport`, `PacketDurableIngestionReceipt`
- `PacketGuardErrorDetail`, `PacketIngestDecision`, `PacketIntentAnchor`, `PacketIntentClassification`, `PacketPlanIngestionMapping`, `PacketReadReceipt`, `PacketSupersessionLink`, `PacketUrgencyClassification`
- `PeerAwarenessDecision`, `PeerAwarenessPolicy`, `PeerHeartbeatEvidence`, `PlanIntentIngestionReceipt`, `PlanIterationSession`, `PlanRowContractRefsResolveGuard`, `PlanSourceSnapshot`, `PlatformContractRegistry`
