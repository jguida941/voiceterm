...
|---|---:|---|
| `dev/scripts/devctl` | 2102 | commands=542, tests=513, runtime=338, review_channel=276, platform=75, governance=74, (root)=62, context_graph=47 |
| `dev/scripts/checks` | 442 | (root)=139, package_layout=32, platform_contract_closure=21, review_probes=21, python_analysis=17, multi_agent_sync=16, code_shape=15, rust_analysis=15 |
