...
|---|---:|---|
| `dev/scripts/devctl` | 2502 | commands=628, tests=624, runtime=480, review_channel=318, platform=88, governance=74, (root)=63, context_graph=47 |
| `dev/scripts/checks` | 574 | (root)=181, package_layout=32, platform_contract_closure=22, review_probes=21, multi_agent_sync=19, python_analysis=17, code_shape=15, rust_analysis=15 |
...
- source_contract_count: 212
- connected_contract_count: 212
- rendered_contract_count: 21
- omitted_contract_count: 191
...
- `AgentMindConsumptionReceipt`, `AgentRelaunchTrigger`, `AgentResumeReceipt`, `AgentSessionContinuation`, `AgentSessionOutcome`, `AgentWorkflowSpec`, `ArtifactStore`, `AssistantGuideMode`
- `AutoModeState`, `AutoRepairReceipt`, `BaselineAuthorityInventoryReceipt`, `BranchOperationReceipt`, `BridgeSeparationGuard`, `BypassEvaluation`, `BypassExpiry`, `BypassLifecycle`
- `BypassReceipt`, `BypassRequest`, `CallerAuthorityPolicy`, `CapabilityGrantState`, `CharterDelivery`, `CheckNonTrivialOutputProofCommand`, `CheckResult`, `CheckoutInventory`
- `CheckoutInventoryClassification`, `CheckoutInventoryRow`, `CheckpointBudgetShape`, `CheckpointRepairAuthority`, `ClassifierSafetyAttestation`, `ClosureProof`, `CloudFinding`, `CollaborationModeTopology`
- `CommandOutputReceipt`, `CommitBodyPacketAnchorsGuard`, `CommitMessageRowIdResolvesGuard`, `CommitReceipt`, `ComposesWith`, `ConnectivityRegistrySnapshot`, `ContextGraphDelta`, `ContextGraphSnapshot`
- `ContextGraphSnapshotFreshnessGuard`, `ContinuousImprovementMode`, `ContractRef`, `ContractRegistryCompositeKeyUniqueness`, `ContractRegistryCompositeKeyUniquenessCommand`, `ControlPlaneReadModel`, `ControlState`, `CoordinationSnapshot`
- `CoordinationTopologySnapshot`, `CorrelationContext`, `CustomRoleDefinition`, `DecidedPacketDebtDetector`, `DecisionPacket`, `DecisionTtlEvidence`, `DevelopRoleAdapterSpec`, `DevelopmentCampaignRoleState`
- `DevelopmentLoopReport`, `DevelopmentModeTopology`, `DogfoodSelfCheckReceipt`, `DurableSchemaPolicy`, `EvidenceArchiveManifest`, `EvidenceArchivePolicy`, `EvidenceArchiveReceipt`, `EvidenceArchiveRefResolution`
- `ExceptionClass`, `ExceptionLifecycleStatus`, `ExceptionPolicy`, `ExceptionReceipt`, `ExtensionBundle`, `FailurePacket`, `FeatureLifecycleProof`, `FeatureProofReceipt`
- `FileTopology`, `Finding`, `FindingAffectedScope`, `FindingApplicability`, `FindingBacklog`, `FindingReview`, `FindingTtlEvidence`, `GitMutationProofReceipt`
- `GoalProgressReceipt`, `GovernanceCompatibilityClaim`, `GovernedExceptionLifecycle`, `GovernedTransitionCheck`, `GovernedTransitionError`, `GovernedTransitionInput`, `GovernedTransitionModule`, `GroundTruthProbeRunReceipt`
- `IllegalTransition`, `IngestionProvenance`, `LifecycleReceipt`, `LocalServiceEndpoint`, `MandatoryIngestBeforeImplementInvariant`, `ManualBypassImportReceipt`, `ModeChangeReceipt`, `NonTrivialOutputProof`
- `NonTrivialOutputProofRemediationFinding`, `NonTrivialOutputProofRemediationFindingLedger`, `OperatorCommandWrapper`, `OperatorDirectivePacket`, `OrphanInventoryReport`, `OrphanReconciliationDecision`, `OrphanSnapshot`, `OrphanSnapshotStats`
- `OrphanSource`, `OrphanSourceClassification`, `OrphanSourceDecision`, `PacketADRReceipt`, `PacketAttentionDrainReport`, `PacketAttentionIngestionDecision`, `PacketBacklogPressure`, `PacketBatchTriage`
- `PacketBatchTriageRow`, `PacketDebtRemediationReport`, `PacketDebtRemediationRow`, `PacketDurableIngestionReceipt`, `PacketGuardErrorDetail`, `PacketIngestDecision`, `PacketIntentAnchor`, `PacketIntentClassification`
- `PacketKindTtl`, `PacketObservationReceipt`, `PacketPlanIngestionMapping`, `PacketReadReceipt`, `PacketSupersessionLink`, `PacketUrgencyClassification`, `PeerAwarenessDecision`, `PeerAwarenessPolicy`
- `PeerHeartbeatEvidence`, `PlanIntentIngestionReceipt`, `PlanIterationSession`, `PlanRowClosureReceipt`, `PlanRowContractRefsResolveGuard`, `PlanSourceSnapshot`, `PlanningIRSnapshot`, `PlatformContractRegistry`
- `PlatformContractRegistryRow`, `PlatformFindingIngest`, `PlatformGuide`, `PreDecisionComposabilityWindow`, `ProbeAllowlist`, `ProbeReport`, `ProviderAdapter`, `PublicationEpisode`
- `PushAuthorizationRecord`, `QualityFeedbackSnapshot`, `QuestionTtlEvidence`, `QueueBypassReasoning`, `RawGitBypassReceipt`, `RelationshipGraph`, `RelaunchQuotaExceeded`, `RemoteCommitPipelineContract`
- `RemoteControlAttachmentState`, `RemoteControlCollaborationCampaign`, `RemoteControlInvocationReceipt`, `RepairPacket`, `RepoPack`, `RepoPortabilityCheck`, `ResolutionReceipt`, `ReviewCandidateRecord`
- `ReviewChannelCommandFreshness`, `ReviewPacket`, `ReviewState`, `ReviewTargets`, `ReviewerAuditReceipt`, `ReviewerResponseShape`, `ReviewerRuntimeContract`, `RoleCapability`
- `RoleCapabilityRegistry`, `RoleCommandEnvelope`, `RoleCreationAction`, `RoleGuard`, `RoleInstructionCard`, `RoleReviewAssignmentLifecycle`, `RoleReviewReceipt`, `RoleReviewTimeout`
...
- `SystemMapSnapshot`, `SystemPicture`, `TagReceipt`, `TaskCompleteDecision`, `TaskProducedTtlEvidence`, `TaskStartedAdrPrecedentLinkingGuard`, `ToggleReceipt`, `TokenOptimizationDogfoodReceipt`
- `TransitionContract`, `TypedAction`, `TypedGateFailure`, `TypedNamespaceCompositionGuard`, `TypedOutputHumanSummary`, `TypingCompatUtility`, `WorkPublicationLedger`, `WorkPublicationLedgerEvent`
- `WorkPublicationLedgerHeader`, `WorkflowAdapter`, `WorkflowStep`, `WorktreeBaseline`
