...
|---|---:|---|
| `dev/scripts/devctl` | 2345 | commands=606, tests=564, runtime=423, review_channel=308, platform=82, governance=74, (root)=62, context_graph=47 |
| `dev/scripts/checks` | 472 | (root)=148, package_layout=32, platform_contract_closure=22, review_probes=21, multi_agent_sync=18, python_analysis=17, code_shape=15, rust_analysis=15 |
