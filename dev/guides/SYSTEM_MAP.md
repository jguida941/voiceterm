...
|---|---:|---|
| `dev/scripts/devctl` | 2363 | commands=609, tests=574, runtime=426, review_channel=308, platform=83, governance=74, (root)=62, context_graph=47 |
...
- source_contract_count: 169
- connected_contract_count: 169
- rendered_contract_count: 21
- omitted_contract_count: 148
...
- `CheckpointBudgetShape`, `CheckpointRepairAuthority`, `ClassifierSafetyAttestation`, `ClosureProof`, `CollaborationModeTopology`, `CommitBodyPacketAnchorsGuard`, `CommitReceipt`, `ComposesWith`
- `ContextGraphDelta`, `ContextGraphSnapshot`, `ContextGraphSnapshotFreshnessGuard`, `ContinuousImprovementMode`, `ContractRef`, `ControlPlaneReadModel`, `ControlState`, `CoordinationSnapshot`
- `CorrelationContext`, `CustomRoleDefinition`, `DecisionPacket`, `DevelopRoleAdapterSpec`, `DevelopmentCampaignRoleState`, `DevelopmentLoopReport`, `DevelopmentModeTopology`, `DogfoodSelfCheckReceipt`
- `EvidenceArchiveManifest`, `EvidenceArchivePolicy`, `EvidenceArchiveReceipt`, `ExceptionClass`, `ExceptionLifecycleStatus`, `ExceptionPolicy`, `ExceptionReceipt`, `FailurePacket`
- `FeatureLifecycleProof`, `FileTopology`, `Finding`, `FindingBacklog`, `FindingReview`, `GoalProgressReceipt`, `GovernanceCompatibilityClaim`, `GovernedExceptionLifecycle`
- `GovernedTransitionModule`, `GroundTruthProbeRunReceipt`, `IngestionProvenance`, `LifecycleReceipt`, `LocalServiceEndpoint`, `MandatoryIngestBeforeImplementInvariant`, `ManualBypassImportReceipt`, `ModeChangeReceipt`
- `OperatorCommandWrapper`, `OrphanInventoryReport`, `OrphanReconciliationDecision`, `OrphanSnapshot`, `OrphanSnapshotStats`, `OrphanSource`, `OrphanSourceClassification`, `OrphanSourceDecision`
- `PacketADRReceipt`, `PacketAttentionIngestionDecision`, `PacketBacklogPressure`, `PacketDebtRemediationReport`, `PacketDurableIngestionReceipt`, `PacketGuardErrorDetail`, `PacketIngestDecision`, `PacketIntentAnchor`
...
- `RawGitBypassReceipt`, `RelationshipGraph`, `RelaunchQuotaExceeded`, `RemoteCommitPipelineContract`, `RemoteControlAttachmentState`, `RemoteControlCollaborationCampaign`, `RemoteControlInvocationReceipt`, `RepoPack`
...
- `SkillCompatibilityValidator`, `SkillLoadReceipt`, `SkillManifest`, `SliceClosureEvent`, `StalledQueueFinding`, `SystemPicture`, `TaskCompleteDecision`, `TaskStartedAdrPrecedentLinkingGuard`
- `ToggleReceipt`, `TokenOptimizationDogfoodReceipt`, `TransitionContract`, `TypedAction`, `TypedGateFailure`, `TypedNamespaceCompositionGuard`, `TypedOutputHumanSummary`, `WorkPublicationLedger`
