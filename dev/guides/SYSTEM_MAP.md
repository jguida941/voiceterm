...
|---|---:|---|
| `dev/scripts/devctl` | 2351 | commands=607, tests=568, runtime=424, review_channel=308, platform=82, governance=74, (root)=62, context_graph=47 |
| `dev/scripts/checks` | 482 | (root)=150, package_layout=32, platform_contract_closure=22, review_probes=21, multi_agent_sync=18, python_analysis=17, code_shape=15, rust_analysis=15 |
