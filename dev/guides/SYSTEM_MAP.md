...
|---|---:|---|
| `dev/scripts/devctl` | 1669 | tests=446, commands=397, runtime=228, review_channel=206, governance=68, platform=61, (root)=58, context_graph=38 |
| `dev/scripts/checks` | 394 | (root)=124, package_layout=32, platform_contract_closure=21, python_analysis=17, review_probes=16, code_shape=15, rust_analysis=15, multi_agent_sync=12 |
