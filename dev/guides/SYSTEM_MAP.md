...
|---|---:|---|
| `dev/scripts/devctl` | 2160 | commands=561, tests=516, runtime=362, review_channel=288, platform=75, governance=74, (root)=62, context_graph=47 |
...
- source_contract_count: 86
- connected_contract_count: 86
- rendered_contract_count: 13
- omitted_contract_count: 73
