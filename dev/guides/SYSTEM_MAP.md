...
|---|---:|---|
| `dev/scripts/devctl` | 2443 | commands=617, tests=606, runtime=457, review_channel=313, platform=86, governance=74, (root)=63, context_graph=47 |
| `dev/scripts/checks` | 514 | (root)=166, package_layout=32, platform_contract_closure=22, review_probes=21, multi_agent_sync=18, python_analysis=17, code_shape=15, rust_analysis=15 |
