...
|---|---:|---|
| `dev/scripts/devctl` | 2353 | commands=607, tests=569, runtime=425, review_channel=308, platform=82, governance=74, (root)=62, context_graph=47 |
...
- source_contract_count: 126
- connected_contract_count: 126
- rendered_contract_count: 21
- omitted_contract_count: 105
...
- `AcceptAllOrphansAction`, `AcceptAllOrphansReceipt`, `ActionResult`, `ActorAuthorityState`, `AgentDispatchRouter`, `AgentLoopBilateralProtocol`, `AgentRelaunchTrigger`, `AgentResumeReceipt`
- `AgentSessionContinuation`, `AgentSessionOutcome`, `ArtifactStore`, `AutoModeState`, `AutoRepairReceipt`, `BaselineAuthorityInventoryReceipt`, `BypassEvaluation`, `BypassExpiry`
- `BypassLifecycle`, `BypassReceipt`, `BypassRequest`, `CallerAuthorityPolicy`, `CapabilityGrantState`, `CheckResult`, `CheckoutInventory`, `CheckoutInventoryClassification`
- `CheckoutInventoryRow`, `CheckpointBudgetShape`, `CheckpointRepairAuthority`, `ClassifierSafetyAttestation`, `ClosureProof`, `CollaborationModeTopology`, `CommitReceipt`, `ContextGraphDelta`
- `ContextGraphSnapshot`, `ControlPlaneReadModel`, `ControlState`, `CoordinationSnapshot`, `CorrelationContext`, `CustomRoleDefinition`, `DecisionPacket`, `DevelopRoleAdapterSpec`
- `DevelopmentCampaignRoleState`, `DevelopmentLoopReport`, `DevelopmentModeTopology`, `DogfoodSelfCheckReceipt`, `EvidenceArchiveManifest`, `EvidenceArchivePolicy`, `EvidenceArchiveReceipt`, `ExceptionClass`
- `ExceptionLifecycleStatus`, `ExceptionPolicy`, `ExceptionReceipt`, `FailurePacket`, `FileTopology`, `Finding`, `FindingBacklog`, `FindingReview`
- `GoalProgressReceipt`, `GovernedExceptionLifecycle`, `GovernedTransitionModule`, `GroundTruthProbeRunReceipt`, `LocalServiceEndpoint`, `ManualBypassImportReceipt`, `OrphanInventoryReport`, `OrphanReconciliationDecision`
- `OrphanSnapshot`, `OrphanSnapshotStats`, `OrphanSource`, `OrphanSourceClassification`, `OrphanSourceDecision`, `PacketAttentionIngestionDecision`, `PacketBacklogPressure`, `PacketDebtRemediationReport`
- `PacketDurableIngestionReceipt`, `PacketGuardErrorDetail`, `PacketIngestDecision`, `PacketIntentAnchor`, `PacketIntentClassification`, `PeerAwarenessDecision`, `PeerAwarenessPolicy`, `PeerHeartbeatEvidence`
- `PlanIntentIngestionReceipt`, `PlanIterationSession`, `PlanSourceSnapshot`, `PlatformContractRegistry`, `PlatformContractRegistryRow`, `PlatformFindingIngest`, `PreDecisionComposabilityWindow`, `ProbeAllowlist`
- `ProbeReport`, `ProviderAdapter`, `PublicationEpisode`, `PushAuthorizationRecord`, `QualityFeedbackSnapshot`, `RawGitBypassReceipt`, `RelaunchQuotaExceeded`, `RemoteCommitPipelineContract`
- `RemoteControlAttachmentState`, `RemoteControlCollaborationCampaign`, `RemoteControlInvocationReceipt`, `RepoPack`, `RepoPortabilityCheck`, `ResolutionReceipt`, `ReviewCandidateRecord`, `ReviewChannelCommandFreshness`
- `ReviewPacket`, `ReviewState`, `ReviewTargets`, `ReviewerAuditReceipt`, `ReviewerResponseShape`, `ReviewerRuntimeContract`, `RoleCreationAction`, `RoleGuard`
- `RoleInstructionCard`, `RunRecord`, `RuntimeTruthSnapshot`, `RustAuditReport`, `SecurityReport`, `SessionActivityEntry`, `SessionActivityLog`, `SessionCachePacket`
- `SessionLease`, `SessionLivenessReconciler`, `SessionLivenessSignal`, `SessionOrientationPacket`, `SessionPosture`, `SessionStatusProjection`, `SessionTerminationPolicy`, `SliceClosureEvent`
- `SystemPicture`, `TaskCompleteDecision`, `TransitionContract`, `TypedAction`, `TypedGateFailure`, `WorkPublicationLedger`, `WorkPublicationLedgerEvent`, `WorkPublicationLedgerHeader`
- `WorkflowAdapter`, `WorktreeBaseline`
