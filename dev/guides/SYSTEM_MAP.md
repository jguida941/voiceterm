...
|---|---:|---|
| `dev/scripts/devctl` | 1975 | commands=498, tests=497, runtime=307, review_channel=266, governance=70, platform=66, (root)=58, context_graph=41 |
| `dev/scripts/checks` | 430 | (root)=136, package_layout=32, platform_contract_closure=21, review_probes=21, python_analysis=17, multi_agent_sync=16, code_shape=15, rust_analysis=15 |
...
- source_contract_count: 63
- connected_contract_count: 63
