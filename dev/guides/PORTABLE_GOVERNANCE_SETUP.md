# Portable Governance Setup For `codex-voice`
...
- detected_capabilities: `Python + Rust`
- starter_policy_path: `dev/config/devctl_repo_policy.json`
- starter_policy_preset: `quality_presets/portable_python_rust.json`
...
2. `cd /Users/jguida941/testing_upgrade/codex-voice`
