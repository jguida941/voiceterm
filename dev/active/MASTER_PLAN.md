...
- MP-350 closure update (2026-03-05): additive read-only MCP adapter
  ...
  guidance lives in `dev/MCP_DEVCTL_ALIGNMENT.md`.
- MP-347 architecture-audit refresh (2026-03-05): core tooling/runtime guard
  ...
  risk-add-on SSOT consolidation, docs-check policy dedup
  (`docs_check_constants.py` vs `docs_check_policy.py`), local strict-hygiene
  repeatability noise (`__pycache__` warning churn unless `--fix`), function-
  exception paydown before `2026-05-15`, and dead-code allow backlog
  reduction.
