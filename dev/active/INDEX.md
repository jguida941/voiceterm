...
| `dev/active/remote_orchestration.md` | `spec` | `mirrored in MASTER_PLAN` | `MP-358` | when working on phone-steered remote-control orchestration, operator-lane bridge/client projections, remote wrapper/bootstrap flows, or thin rollover/recovery adapters over the existing review-channel state machine |
