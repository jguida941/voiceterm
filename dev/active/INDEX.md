...
| `dev/active/remote_control_runtime.md` | `spec` | `mirrored in MASTER_PLAN` | `MP-380..MP-386` | after `ai_governance_platform.md`, `platform_authority_loop.md`, and `remote_commit_pipeline.md`, read this when closing remote-control reviewer/runtime state, operator action transport, dashboard typed projections, auto-poll/update cadence, or discoverability/system-map surfaces for phone-steered sessions |
