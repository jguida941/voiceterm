...
| `2026-03-06T15:09:07Z` | `CODEX` | `MP-265` | `rust/src/bin/voiceterm/theme/rule_profile.rs` | `mp265-rule-profile-test-extraction` | `extraction-refactor` | `completed` | `Moved inline tests to rust/src/bin/voiceterm/theme/rule_profile/tests.rs and removed the raised code-shape override after the runtime module dropped below the Rust default soft limit.` |
| `2026-03-06T15:26:01Z` | `CODEX` | `MP-265` | `rust/src/bin/voiceterm/status_line/format.rs` | `mp265-status-line-single-line-extraction` | `extraction-refactor` | `completed` | `Extracted compact/minimal helpers to rust/src/bin/voiceterm/status_line/format/compact.rs and single-line helpers to rust/src/bin/voiceterm/status_line/format/single_line.rs, reducing status_line/format.rs from 990 to 657 and removing the raised code-shape override.` |
