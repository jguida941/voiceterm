...
`dev/active/` contains current execution-state planning docs.

Read order for agents and maintainers:

1. `dev/active/INDEX.md`
2. `dev/active/MASTER_PLAN.md`
3. Scope-specific docs referenced by `INDEX.md`
