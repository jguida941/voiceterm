...
- HEAD SHA: `36e294463611581768360285071746f5de04ace4`
- HEAD author: Justin Guida
- HEAD timestamp (UTC): 2026-04-27T23:46:38-04:00
...
- publication_guidance: 39 local commit(s) waiting for governed push once review is accepted.
...
Range: last 24 commits ending at `36e294463611`
...
|---|---|---|---|---|---|---|
| 1 | `36e29446` | Plan 4.1 T20 same-HEAD completed-handoff fallback (Codex 32… | 13 | +551/-187 | tooling |  |
| 2 | `a0a09dec` | Refresh external review snapshot for 42f65def | 2 | +51/-52 | docs |  |
| 3 | `42f65def` | Refresh external review snapshot for 80e9299e | 1 | +69/-69 | tooling |  |
| 4 | `80e9299e` | Plan 4.1 T20 + composed wedges: AgentSessionOutcome typed c… | 32 | +1658/-357 | tooling |  |
| 5 | `8543d8ce` | Refresh external review snapshot for c985fc64 | 2 | +43/-43 | docs |  |
| 6 | `c985fc64` | Refresh external review snapshot for 4d3b4863 | 1 | +71/-68 | tooling |  |
| 7 | `4d3b4863` | Refresh external review snapshot for f0a34191 | 2 | +92/-78 | docs |  |
| 8 | `f0a34191` | Plan 4.1 Path I commit-pipeline self-resolution + rev_pkt_2… | 47 | +1887/-367 | tooling | Parser / ANSI boundary |
| 9 | `120c1249` | Refresh external review snapshot for eee2cc6d | 2 | +44/-44 | docs |  |
| 10 | `eee2cc6d` | Refresh external review snapshot for 05a30319 | 1 | +56/-56 | tooling |  |
| 11 | `05a30319` | Refresh external review snapshot for 92b1f57d | 2 | +43/-43 | docs |  |
| 12 | `92b1f57d` | Refresh external review snapshot for 62cd83cc | 1 | +48/-46 | tooling |  |
| 13 | `62cd83cc` | Refresh external review snapshot for 499baa8b | 1 | +1/-1 | tooling |  |
| 14 | `499baa8b` | Refresh external review snapshot for f6e3783d | 2 | +64/-65 | docs |  |
| 15 | `f6e3783d` | Refresh external review snapshot for 80c1791a | 1 | +43/-43 | tooling |  |
| 16 | `80c1791a` | Refresh external review snapshot for aebed8b5 | 1 | +50/-47 | tooling |  |
| 17 | `aebed8b5` | Refresh external review snapshot for f86e0db2 | 2 | +55/-60 | docs |  |
| 18 | `f86e0db2` | Plan 4.1 catch-22 unblock: push.py import for build_push_ac… | 2 | +59/-58 | tooling |  |
| 19 | `d70b2b6f` | Plan 4.1 catch-22 unblock: post-receipt startup-context ref… | 4 | +236/-64 | tooling |  |
| 20 | `0503204b` | Refresh external review snapshot for 196a2f7f | 1 | +40/-40 | tooling |  |
| 21 | `196a2f7f` | Refresh external review snapshot for f429524b | 1 | +43/-43 | tooling |  |
| 22 | `f429524b` | Refresh external review snapshot for 7e78f6c0 | 1 | +69/-72 | tooling |  |
| 23 | `7e78f6c0` | Refresh external review snapshot for 7bf66f03 | 2 | +81/-82 | docs |  |
| 24 | `7bf66f03` | Plan 4.1 bounded slice: G1 push.py duplicate fix + G2 push_… | 35 | +2281/-513 | tooling |  |
...
|---|---|---|
| `AGENTS.md` | docs | +5/-1 |
| `bridge.md` | docs | +90/-91 |
| `dev/active/MASTER_PLAN.md` | tooling | +97/-13 |
| `dev/active/agent_substrate_architecture_review.md` | tooling | +17/-0 |
| `dev/active/ai_governance_platform.md` | tooling | +159/-13 |
| `dev/audits/AUTOMATION_DEBT_REGISTER.md` | tooling | +4/-0 |
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1291/-1278 |
| `dev/guides/DEVELOPMENT.md` | docs | +33/-8 |
| `dev/guides/SYSTEM_MAP.md` | docs | +7/-7 |
| `dev/history/ENGINEERING_EVOLUTION.md` | tooling | +133/-5 |
| `dev/scripts/README.md` | tooling | +41/-12 |
...
| `dev/scripts/devctl/commands/vcs/governed_executor_push_result.py` | tooling | +42/-3 |
...
| `dev/scripts/devctl/commands/vcs/push.py` | tooling | +113/-130 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-a28eb897c719` binds this file to HEAD `36e294463611`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
