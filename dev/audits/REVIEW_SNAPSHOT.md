...
- HEAD: `5734839a5b36` — Refresh external review snapshot for 5340d350
- Tree hash: `769253d453cd`
- Generation stamp: `snap-a2bf34e882d0`
- Generated at (UTC): 2026-05-13T02:55:24Z
- Push decision: `await_checkpoint` — staged_index_present
- Reviewer mode: `single_agent` (interaction: `single_agent`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 64 files, +5655/-4514
...
- HEAD SHA: `5734839a5b36dab20923768acccbb416768bcc81`
...
Range: last 24 commits ending at `5734839a5b36`
...
|---|---|---|---|---|---|---|
| 1 | `5734839a` | Refresh external review snapshot for 5340d350 | 2 | +60/-60 | docs |  |
| 2 | `5340d350` | Register Claude automation safety declaration | 3 | +102/-49 | tooling |  |
| 3 | `80fbb684` | Refresh external review snapshot for b4acaba1 | 2 | +58/-66 | docs |  |
| 4 | `b4acaba1` | Allow review-only action requests through commit gate | 4 | +202/-102 | tooling |  |
| 5 | `2135698e` | Refresh external review snapshot for d700ecb9 | 2 | +57/-57 | docs |  |
| 6 | `d700ecb9` | Reuse CLI command handler rows | 2 | +59/-70 | tooling |  |
| 7 | `2aac05ed` | Refresh external review snapshot for aaf17ee5 | 2 | +63/-67 | docs |  |
| 8 | `aaf17ee5` | Reduce orchestration adapter parameter surfaces | 5 | +92/-153 | tooling |  |
| 9 | `376cd632` | Refresh policy-owned generated surfaces for 7f3a73c8 | 1 | +2/-2 | docs |  |
| 10 | `7f3a73c8` | Refresh external review snapshot for a1c11da2 | 2 | +70/-69 | docs |  |
| 11 | `a1c11da2` | Split governance modules for code shape compliance | 42 | +3643/-2792 | tooling |  |
| 12 | `a9415b9a` | Refresh policy-owned generated surfaces for 7e006123 | 1 | +1/-1 | docs |  |
| 13 | `7e006123` | Refresh external review snapshot for 8d5bb18a | 2 | +56/-53 | docs |  |
| 14 | `8d5bb18a` | Checkpoint listing package projections | 4 | +51/-49 | tooling |  |
| 15 | `32545d54` | Package devctl list command | 4 | +221/-242 | tooling |  |
| 16 | `cdc5b9a1` | Refresh policy-owned generated surfaces for f91cbada | 1 | +1/-1 | docs |  |
| 17 | `f91cbada` | Refresh external review snapshot for 725c000d | 2 | +57/-57 | docs |  |
| 18 | `725c000d` | Allow shared schema fixture roots | 6 | +455/-319 | tooling |  |
| 19 | `97992ae2` | Refresh external review snapshot for 81f85b53 | 2 | +54/-54 | docs |  |
| 20 | `81f85b53` | Checkpoint live packet projections | 4 | +49/-47 | tooling |  |
| 21 | `454b6230` | Refresh ground truth probe receipt | 2 | +51/-50 | tooling |  |
| 22 | `eddba7ea` | Refresh external review snapshot for 555fa483 | 2 | +56/-56 | docs |  |
| 23 | `555fa483` | Checkpoint push bypass packet projections | 3 | +50/-46 | tooling |  |
| 24 | `05adb548` | Allow publish-clear managed projection receipts | 5 | +145/-52 | tooling |  |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-a2bf34e882d0` binds this file to HEAD `5734839a5b36`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
