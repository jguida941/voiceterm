...
- HEAD: `6bd6f2077d6c` — Fix governed commit pipeline retention
- Tree hash: `96db2405e9c8`
- Generation stamp: `snap-fd271cd88b40`
- Generated at (UTC): 2026-05-12T20:41:52Z
- Push decision: `run_devctl_push` — push_preconditions_satisfied
- Reviewer mode: `single_agent` (interaction: `remote_control`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 245 files, +21177/-1827
...
- HEAD SHA: `6bd6f2077d6c24c9655864178812308c8146ef5d`
...
Range: last 24 commits ending at `6bd6f2077d6c`
...
|---|---|---|---|---|---|---|
| 1 | `6bd6f207` | Fix governed commit pipeline retention | 10 | +230/-56 | tooling |  |
| 2 | `42683c3f` | Refresh external review snapshot for c8cf1c84 | 2 | +49/-48 | docs |  |
| 3 | `c8cf1c84` | Post-commit working tree cleanup: bridge heartbeat + codesm… | 4 | +39/-3 | docs |  |
| 4 | `e76ed6f3` | Refresh external review snapshot for eb336244 | 2 | +82/-76 | docs |  |
| 5 | `eb336244` | Land MP377 BypassLifecycle composability + charter addition… | 48 | +2199/-407 | tooling |  |
| 6 | `b331baa1` | Refresh external review snapshot for 0352553b | 2 | +85/-78 | docs |  |
| 7 | `0352553b` | Checkpoint MP377-P0-CHECKPOINT-AUTOMATION-S1 slice work (cl… | 60 | +3582/-139 | tooling |  |
| 8 | `0928a483` | Stage agent_supervise import set + adapter wiring (recover… | 8 | +808/-2 | tooling |  |
| 9 | `28bcafdd` | Refresh policy-owned generated surfaces for 87554eb9 | 1 | +16/-16 | docs |  |
| 10 | `87554eb9` | Refresh external review snapshot for 9249e17c | 2 | +138/-85 | docs |  |
| 11 | `9249e17c` | Land MP-377 typed governance work-in-progress (multi-slice) | 176 | +12985/-235 | tooling |  |
| 12 | `771a7fa5` | Refresh external review snapshot for 73417c6a | 2 | +71/-72 | docs |  |
| 13 | `73417c6a` | Stop push preflight projection receipt loops | 5 | +138/-53 | tooling |  |
| 14 | `fd9ed509` | Refresh external review snapshot for c9616cfe | 2 | +55/-55 | docs |  |
| 15 | `c9616cfe` | Fix push bridge sync test mocks | 4 | +51/-56 | tooling |  |
| 16 | `170167c1` | Refresh external review snapshot for fe5b9538 | 2 | +66/-65 | docs |  |
| 17 | `fe5b9538` | Fix startup reviewer mode authority | 5 | +95/-60 | tooling |  |
| 18 | `18685099` | Refresh external review snapshot for c4e50e10 | 2 | +40/-40 | docs |  |
| 19 | `c4e50e10` | Refresh external review snapshot for 1036a84b | 2 | +64/-64 | docs |  |
| 20 | `1036a84b` | Document push preflight projection policy | 9 | +94/-55 | tooling |  |
| 21 | `8b8900d6` | Refresh external review snapshot for 0fa60654 | 2 | +64/-62 | docs |  |
| 22 | `0fa60654` | Fix push preflight audit routing | 8 | +185/-59 | tooling |  |
| 23 | `5b5c0d06` | Refresh external review snapshot for 9aba52e2 | 1 | +40/-40 | tooling |  |
| 24 | `9aba52e2` | Refresh policy-owned generated surfaces for 905794d7 | 1 | +1/-1 | docs |  |
...
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1070/-1006 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-fd271cd88b40` binds this file to HEAD `6bd6f2077d6c`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
