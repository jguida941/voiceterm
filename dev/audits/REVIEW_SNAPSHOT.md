...
- HEAD: `1ea5b46ba5c4` — Refresh external review snapshot for 89fb139b
- Tree hash: `ea7ccde43e9f`
- Generation stamp: `snap-de2569a2ba23`
- Generated at (UTC): 2026-05-07T19:20:33Z
- Push decision: `run_devctl_push` — push_preconditions_satisfied
- Reviewer mode: `tools_only` (interaction: `local_terminal`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 168 files, +10915/-3919
...
- HEAD SHA: `1ea5b46ba5c4d715b74607f3f88676327fa1ba19`
- HEAD author: Justin Guida
- HEAD timestamp (UTC): 2026-05-07T15:18:33-04:00
...
Range: last 24 commits ending at `1ea5b46ba5c4`
...
|---|---|---|---|---|---|---|
| 1 | `1ea5b46b` | Refresh external review snapshot for 89fb139b | 2 | +43/-42 | docs |  |
| 2 | `89fb139b` | Refresh external review snapshot for fd14c251 | 2 | +63/-66 | docs |  |
| 3 | `fd14c251` | Ingest guard smartness automation findings | 6 | +96/-49 | tooling |  |
| 4 | `84bb8da1` | Refresh external review snapshot for 3c74fb47 | 2 | +62/-66 | docs |  |
| 5 | `3c74fb47` | Fix checkpoint retry restaging | 15 | +147/-67 | tooling |  |
| 6 | `533fb308` | Automate checkpoint staging and next selection | 21 | +637/-101 | tooling |  |
| 7 | `d10257cd` | Refresh external review snapshot for 42addd24 | 2 | +56/-58 | docs |  |
| 8 | `42addd24` | Fix develop next typed plan selection | 6 | +196/-63 | tooling |  |
| 9 | `7482406d` | Refresh external review snapshot for ba581203 | 2 | +55/-55 | docs |  |
| 10 | `ba581203` | Refresh external review snapshot for 3d532df6 | 2 | +76/-77 | docs |  |
| 11 | `3d532df6` | Refresh policy-owned generated surfaces for 95a1050e | 1 | +2/-2 | docs |  |
| 12 | `95a1050e` | Refresh external review snapshot for 78741171 | 2 | +123/-95 | docs |  |
| 13 | `78741171` | Checkpoint packet intake and role authority repairs | 159 | +8583/-2539 | tooling |  |
| 14 | `e3f17d25` | Refresh external review snapshot for d48cf3b4 | 2 | +53/-48 | docs |  |
| 15 | `d48cf3b4` | Refresh external review snapshot for 06e31e4e | 2 | +49/-52 | docs |  |
| 16 | `06e31e4e` | Refresh external review snapshot for dbaa9ad3 | 2 | +65/-66 | docs |  |
| 17 | `dbaa9ad3` | Ingest packet expiry lifecycle sweep plan | 8 | +129/-69 | tooling |  |
| 18 | `1d065cd2` | Refresh external review snapshot for b75cd4c7 | 1 | +60/-60 | tooling |  |
| 19 | `b75cd4c7` | Refresh external review snapshot for 7a73b299 | 1 | +11/-6 | docs |  |
| 20 | `7a73b299` | Refresh external review snapshot for a90c3aa9 | 2 | +44/-44 | docs |  |
| 21 | `a90c3aa9` | Refresh external review snapshot for 2b535a3c | 2 | +46/-44 | docs |  |
| 22 | `2b535a3c` | Refresh external review snapshot for c4fd1c3e | 2 | +75/-81 | docs |  |
| 23 | `c4fd1c3e` | Ingest universal governance lifecycle plan | 8 | +191/-121 | tooling |  |
| 24 | `af287813` | Refresh external review snapshot for 7b73c670 | 2 | +53/-48 | docs |  |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-de2569a2ba23` binds this file to HEAD `1ea5b46ba5c4`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
