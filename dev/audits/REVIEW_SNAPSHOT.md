...
- HEAD: `ee552370655f` — Refresh external review snapshot for f0d0b9db
- Tree hash: `afa6dbd3af92`
- Generation stamp: `snap-abe0e2ff44a3`
- Generated at (UTC): 2026-05-13T04:48:06Z
- Push decision: `await_checkpoint` — staged_index_present
- Reviewer mode: `single_agent` (interaction: `remote_control`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 67 files, +5351/-4236
...
- HEAD SHA: `ee552370655fae98ceeba5f862770a68098c5ed4`
- HEAD author: Justin Guida
- HEAD timestamp (UTC): 2026-05-13T00:30:46-04:00
...
Range: last 24 commits ending at `ee552370655f`
...
|---|---|---|---|---|---|---|
| 1 | `ee552370` | Refresh external review snapshot for f0d0b9db | 2 | +64/-64 | docs |  |
| 2 | `f0d0b9db` | Improve governance CLI dogfood ergonomics | 12 | +129/-55 | tooling |  |
| 3 | `63ce7cbe` | Refresh external review snapshot for 3e9b18d8 | 2 | +56/-55 | docs |  |
| 4 | `3e9b18d8` | Record post-push governance updates | 3 | +87/-56 | docs |  |
| 5 | `47b6ac17` | Refresh external review snapshot for 285123c6 | 2 | +52/-52 | docs |  |
| 6 | `285123c6` | chore(push): auto-commit preflight-generated changes | 1 | +61/-0 | docs |  |
| 7 | `10c86a85` | Refresh external review snapshot for 63e6af81 | 2 | +68/-62 | docs |  |
| 8 | `63e6af81` | Update governed executor projection path test | 5 | +96/-59 | tooling |  |
| 9 | `5734839a` | Refresh external review snapshot for 5340d350 | 2 | +60/-60 | docs |  |
| 10 | `5340d350` | Register Claude automation safety declaration | 3 | +102/-49 | tooling |  |
| 11 | `80fbb684` | Refresh external review snapshot for b4acaba1 | 2 | +58/-66 | docs |  |
| 12 | `b4acaba1` | Allow review-only action requests through commit gate | 4 | +202/-102 | tooling |  |
| 13 | `2135698e` | Refresh external review snapshot for d700ecb9 | 2 | +57/-57 | docs |  |
| 14 | `d700ecb9` | Reuse CLI command handler rows | 2 | +59/-70 | tooling |  |
| 15 | `2aac05ed` | Refresh external review snapshot for aaf17ee5 | 2 | +63/-67 | docs |  |
| 16 | `aaf17ee5` | Reduce orchestration adapter parameter surfaces | 5 | +92/-153 | tooling |  |
| 17 | `376cd632` | Refresh policy-owned generated surfaces for 7f3a73c8 | 1 | +2/-2 | docs |  |
| 18 | `7f3a73c8` | Refresh external review snapshot for a1c11da2 | 2 | +70/-69 | docs |  |
| 19 | `a1c11da2` | Split governance modules for code shape compliance | 42 | +3643/-2792 | tooling |  |
| 20 | `a9415b9a` | Refresh policy-owned generated surfaces for 7e006123 | 1 | +1/-1 | docs |  |
| 21 | `7e006123` | Refresh external review snapshot for 8d5bb18a | 2 | +56/-53 | docs |  |
| 22 | `8d5bb18a` | Checkpoint listing package projections | 4 | +51/-49 | tooling |  |
| 23 | `32545d54` | Package devctl list command | 4 | +221/-242 | tooling |  |
| 24 | `cdc5b9a1` | Refresh policy-owned generated surfaces for f91cbada | 1 | +1/-1 | docs |  |
...
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1165/-1215 |
...
| `dev/scripts/devctl/review_channel/event_render.py` | tooling | +5/-1 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-abe0e2ff44a3` binds this file to HEAD `ee552370655f`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
