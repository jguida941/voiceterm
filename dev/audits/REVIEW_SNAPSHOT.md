...
- HEAD: `555fa4834876` — Checkpoint push bypass packet projections
- Tree hash: `ba0f6ab73518`
- Generation stamp: `snap-e1a4fc9c0bf8`
- Generated at (UTC): 2026-05-12T22:01:22Z
- Push decision: `run_devctl_push` — push_preconditions_satisfied
- Reviewer mode: `single_agent` (interaction: `remote_control`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 246 files, +21659/-1877
...
- HEAD SHA: `555fa4834876c22a547919e570e6d8cd7e6b204d`
...
Range: last 24 commits ending at `555fa4834876`
...
|---|---|---|---|---|---|---|
| 1 | `555fa483` | Checkpoint push bypass packet projections | 3 | +50/-46 | tooling |  |
| 2 | `05adb548` | Allow publish-clear managed projection receipts | 5 | +145/-52 | tooling |  |
| 3 | `c41a0250` | Refresh external review snapshot for c536d666 | 2 | +59/-59 | docs |  |
| 4 | `c536d666` | Checkpoint post-commit packet projections | 4 | +84/-48 | tooling |  |
| 5 | `ed1fbf18` | Refresh external review snapshot for dea85ab1 | 2 | +60/-58 | docs |  |
| 6 | `dea85ab1` | Fix governed commit pipeline reload fallback | 8 | +417/-54 | tooling |  |
| 7 | `753cf164` | Fix governed commit pipeline retention | 8 | +190/-55 | tooling |  |
| 8 | `cae10c5e` | Refresh external review snapshot for 6bd6f207 | 2 | +60/-59 | docs |  |
| 9 | `6bd6f207` | Fix governed commit pipeline retention | 10 | +230/-56 | tooling |  |
| 10 | `42683c3f` | Refresh external review snapshot for c8cf1c84 | 2 | +49/-48 | docs |  |
| 11 | `c8cf1c84` | Post-commit working tree cleanup: bridge heartbeat + codesm… | 4 | +39/-3 | docs |  |
| 12 | `e76ed6f3` | Refresh external review snapshot for eb336244 | 2 | +82/-76 | docs |  |
| 13 | `eb336244` | Land MP377 BypassLifecycle composability + charter addition… | 48 | +2199/-407 | tooling |  |
| 14 | `b331baa1` | Refresh external review snapshot for 0352553b | 2 | +85/-78 | docs |  |
| 15 | `0352553b` | Checkpoint MP377-P0-CHECKPOINT-AUTOMATION-S1 slice work (cl… | 60 | +3582/-139 | tooling |  |
| 16 | `0928a483` | Stage agent_supervise import set + adapter wiring (recover… | 8 | +808/-2 | tooling |  |
| 17 | `28bcafdd` | Refresh policy-owned generated surfaces for 87554eb9 | 1 | +16/-16 | docs |  |
| 18 | `87554eb9` | Refresh external review snapshot for 9249e17c | 2 | +138/-85 | docs |  |
| 19 | `9249e17c` | Land MP-377 typed governance work-in-progress (multi-slice) | 176 | +12985/-235 | tooling |  |
| 20 | `771a7fa5` | Refresh external review snapshot for 73417c6a | 2 | +71/-72 | docs |  |
| 21 | `73417c6a` | Stop push preflight projection receipt loops | 5 | +138/-53 | tooling |  |
| 22 | `fd9ed509` | Refresh external review snapshot for c9616cfe | 2 | +55/-55 | docs |  |
| 23 | `c9616cfe` | Fix push bridge sync test mocks | 4 | +51/-56 | tooling |  |
| 24 | `170167c1` | Refresh external review snapshot for fe5b9538 | 2 | +66/-65 | docs |  |
...
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1129/-1061 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-e1a4fc9c0bf8` binds this file to HEAD `555fa4834876`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
