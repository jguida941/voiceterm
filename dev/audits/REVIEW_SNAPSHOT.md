...
- HEAD: `cd177c3e742a` — Docs: catalog runtime bridge separation guard
- Tree hash: `d583f58c9ac6`
- Generation stamp: `snap-14ab95171d50`
- Generated at (UTC): 2026-05-15T04:55:48Z
- Push decision: `run_devctl_push` — push_preconditions_satisfied
- Reviewer mode: `single_agent` (interaction: `local_terminal`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 25 commits, 522 files, +13047/-1621
...
- HEAD SHA: `cd177c3e742a2da2aa277c6a43a21e93844e841c`
...
Range: last 25 commits ending at `cd177c3e742a`
...
|---|---|---|---|---|---|---|
| 1 | `cd177c3e` | Docs: catalog runtime bridge separation guard | 2 | +53/-53 | tooling |  |
| 2 | `3c98c2ed` | Refresh external review snapshot for 372ea699 | 2 | +66/-68 | docs |  |
| 3 | `372ea699` | Docs: record governed push docs-check repair | 5 | +106/-56 | tooling |  |
| 4 | `b34748b3` | Refresh policy-owned generated surfaces for 8353fc05 | 1 | +28/-27 | docs |  |
| 5 | `8353fc05` | Refresh external review snapshot for e9aad0df | 2 | +62/-60 | docs |  |
| 6 | `e9aad0df` | MP188-S1.1: expand bridge guard FORBIDDEN_MODULE_FRAGMENTS… | 10 | +219/-88 | tooling |  |
| 7 | `1b42c70e` | Refresh external review snapshot for df492548 | 2 | +55/-55 | docs |  |
| 8 | `df492548` | MP197: ingest continuous proof scheduler plan | 5 | +160/-50 | tooling |  |
| 9 | `1ec9c8b1` | Refresh external review snapshot for dbd12b71 | 2 | +73/-75 | docs |  |
| 10 | `dbd12b71` | MP188: add runtime bridge separation guard | 14 | +472/-56 | tooling |  |
| 11 | `56d9ceb3` | Refresh external review snapshot for 8d406cee | 2 | +59/-59 | docs |  |
| 12 | `8d406cee` | MP189: ingest R127 wake continuity plan | 5 | +74/-50 | tooling |  |
| 13 | `c99b616c` | Refresh external review snapshot for 763075f1 | 2 | +67/-64 | docs |  |
| 14 | `763075f1` | MP188: register ingestion provenance | 11 | +142/-56 | tooling |  |
| 15 | `31dee106` | Refresh external review snapshot for b7b13c45 | 2 | +64/-64 | docs |  |
| 16 | `b7b13c45` | MP186: retarget R125 duplicate corrections | 18 | +303/-62 | tooling |  |
| 17 | `644389cd` | Refresh external review snapshot for 9272e871 | 2 | +63/-63 | docs |  |
| 18 | `9272e871` | MP381: stabilize push authorization during preflight | 12 | +270/-124 | tooling |  |
| 19 | `b049ba3a` | Refresh external review snapshot for 868e35c9 | 2 | +72/-77 | docs |  |
| 20 | `868e35c9` | MP381: read canonical push authorization | 14 | +223/-64 | tooling |  |
| 21 | `aee417b6` | Refresh external review snapshot for 866ce516 | 2 | +61/-65 | docs |  |
| 22 | `866ce516` | MP381: fix review-channel self-stop preflight | 12 | +177/-61 | tooling |  |
| 23 | `ff501228` | Refresh external review snapshot for d3b7a100 | 2 | +72/-68 | docs |  |
| 24 | `d3b7a100` | MP381: ingest R98 governance findings | 490 | +10105/-155 | tooling |  |
| 25 | `92488df1` | MP377: checkpoint packet-pressure bridge refresh | 1 | +1/-1 | docs |  |
...
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1382/-1376 |
...
| `dev/scripts/README.md` | tooling | +32/-3 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-14ab95171d50` binds this file to HEAD `cd177c3e742a`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
