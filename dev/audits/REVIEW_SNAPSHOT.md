...
- HEAD: `bf37dd0641f1` — Refresh policy-owned generated surfaces for 4906ad50
- Tree hash: `d896ce961399`
- Generation stamp: `snap-7a4da6e13b10`
- Generated at (UTC): 2026-05-03T09:50:25Z
- Push decision: `run_devctl_push` — push_preconditions_satisfied
- Reviewer mode: `single_agent` (interaction: `single_agent`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 23 files, +1874/-1458
...
- HEAD SHA: `bf37dd0641f122f3300444951d0ee834541ad4e9`
- HEAD author: Justin Guida
- HEAD timestamp (UTC): 2026-05-03T05:50:08-04:00
...
- current_push_authorization: `push-auth-20260503T094753748208Z` (valid=True)
- authorized_head_commit: `4906ad50c726913a3d381d5d9b1b65814d8d3a73`
- approved_target_identity: `tree-receipt-20260503T094753748208Z:00e02a9f15e50b4658316f86df3614700c732c74`
...
Range: last 24 commits ending at `bf37dd0641f1`
...
|---|---|---|---|---|---|---|
| 1 | `bf37dd06` | Refresh policy-owned generated surfaces for 4906ad50 | 1 | +1/-1 | docs |  |
| 2 | `4906ad50` | Refresh external review snapshot for 772a0ce7 | 2 | +60/-55 | docs |  |
| 3 | `772a0ce7` | Treat finding backlog as advisory in session resume | 5 | +247/-148 | tooling |  |
| 4 | `2662a44f` | Refresh external review snapshot for f67eded6 | 2 | +45/-45 | docs |  |
| 5 | `f67eded6` | Refresh external review snapshot for 2096395c | 1 | +46/-43 | tooling |  |
| 6 | `2096395c` | Refresh external review snapshot for bcf72a35 | 2 | +60/-56 | docs |  |
| 7 | `bcf72a35` | Fix idle review-channel status readiness | 8 | +246/-71 | tooling |  |
| 8 | `b3e303b7` | Refresh external review snapshot for 2ff46d1c | 2 | +44/-44 | docs |  |
| 9 | `2ff46d1c` | Refresh external review snapshot for fa2ca61c | 1 | +45/-42 | tooling |  |
| 10 | `fa2ca61c` | Refresh external review snapshot for 9b6cc0d0 | 2 | +65/-58 | docs |  |
| 11 | `9b6cc0d0` | Allow pending-publish pipeline authorization refresh | 6 | +191/-58 | tooling |  |
| 12 | `7cb7ba19` | Refresh external review snapshot for fde85cea | 2 | +50/-55 | docs |  |
| 13 | `fde85cea` | Refresh external review snapshot for d80d603a | 2 | +83/-115 | docs |  |
| 14 | `d80d603a` | Refresh external review snapshot for a1a0468d | 2 | +57/-58 | docs |  |
| 15 | `a1a0468d` | Refresh external review snapshot for de294ab4 | 2 | +69/-67 | docs |  |
| 16 | `de294ab4` | Refresh external review snapshot for 37eb2d78 | 2 | +63/-67 | docs |  |
| 17 | `37eb2d78` | Refresh external review snapshot for cc513241 | 2 | +54/-53 | docs |  |
| 18 | `cc513241` | Refresh external review snapshot for f5d534ad | 2 | +49/-49 | docs |  |
| 19 | `f5d534ad` | Refresh external review snapshot for 1ad2844d | 2 | +53/-50 | docs |  |
| 20 | `1ad2844d` | Refresh external review snapshot for 330a82e6 | 2 | +78/-83 | docs |  |
| 21 | `330a82e6` | Align review-channel launch dry-run test with visible policy | 2 | +67/-58 | tooling |  |
| 22 | `0278cb96` | Migrate Codex provider args from --full-auto to explicit ap… | 8 | +112/-93 | tooling |  |
| 23 | `a982d6d2` | Refresh external review snapshot for 4dee7ce3 | 2 | +46/-46 | docs |  |
| 24 | `4dee7ce3` | Refresh external review snapshot for 6e55bc00 | 1 | +43/-43 | tooling |  |
...
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1165/-1205 |
...
| `dev/scripts/devctl/tests/governance/test_session_resume.py` | tooling | +23/-0 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-7a4da6e13b10` binds this file to HEAD `bf37dd0641f1`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
