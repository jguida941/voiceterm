...
- HEAD: `49d1db53f43a` — Refresh external review snapshot for 363fe42c
- Tree hash: `0888ed245589`
- Generation stamp: `snap-68db695fcb7b`
- Generated at (UTC): 2026-04-09T21:11:43Z
- Push decision: `await_checkpoint` — dirty_path_budget_exceeded
- Reviewer mode: `active_dual_agent` (interaction: `remote_control`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 74 files, +5654/-1714
...
- HEAD SHA: `49d1db53f43a93f54f0bc6203017f108d9981a27`
- HEAD author: Justin Guida
- HEAD timestamp (UTC): 2026-04-09T16:13:33-04:00
...
Range: last 24 commits ending at `49d1db53f43a`
...
|---|---|---|---|---|---|---|
| 1 | `49d1db53` | Refresh external review snapshot for 363fe42c | 1 | +57/-54 | tooling |  |
| 2 | `363fe42c` | fix(hygiene): Platform Boundary fix + regression tests + co… | 3 | +223/-47 | tooling |  |
| 3 | `e4870754` | fix(review-channel): attach-remote-control cleanup (F2.1 th… | 4 | +336/-70 | tooling |  |
| 4 | `d35abef0` | test(process-sweep): positive + negative regression tests f… | 2 | +195/-60 | tooling |  |
| 5 | `971647ec` | fix(rollout-tail): F3 narrow Claude session discovery + tai… | 4 | +351/-58 | tooling | Parser / ANSI boundary |
| 6 | `a65fc7c4` | fix(review): land F1+F2 from Codex reviewer pass | 5 | +161/-58 | tooling |  |
| 7 | `adb266b5` | Refresh external review snapshot for d84b27fa | 1 | +60/-58 | tooling |  |
| 8 | `d84b27fa` | feat(lifecycle): add recoverable flag to ReviewerSupervisor… | 2 | +77/-86 | tooling |  |
| 9 | `8f42ea3f` | feat(devctl): rollout-tail MVP for Codex/Claude session JSO… | 11 | +1088/-49 | tooling | Parser / ANSI boundary |
| 10 | `2ca00812` | Refresh external review snapshot for 696f4772 | 1 | +52/-46 | tooling |  |
| 11 | `696f4772` | fix(hygiene): trust supervisor heartbeat for reparented con… | 2 | +62/-54 | tooling |  |
| 12 | `8c800411` | Refresh external review snapshot for a12b6593 | 1 | +82/-77 | tooling |  |
| 13 | `a12b6593` | feat(review-channel): attach-remote-control action + typed… | 37 | +1188/-131 | tooling | Parser / ANSI boundary |
| 14 | `a5ad7fc0` | fix(runtime): F1 coordination parity via review_state_overr… | 7 | +253/-103 | tooling |  |
| 15 | `838b762c` | Refresh external review snapshot for d7e7e597 | 1 | +57/-51 | tooling |  |
| 16 | `d7e7e597` | policy: declare operator_interaction_mode=remote_control | 2 | +63/-63 | tooling |  |
| 17 | `08770a66` | Refresh external review snapshot for 675ca93d | 1 | +65/-69 | tooling |  |
| 18 | `675ca93d` | fix: scope post-push validation to published diff | 13 | +359/-91 | tooling |  |
| 19 | `a60f1470` | Refresh external review snapshot for 69317302 | 1 | +52/-49 | tooling |  |
| 20 | `69317302` | fix: support coderabbit gate script imports | 3 | +82/-65 | tooling |  |
| 21 | `bc1a40ec` | Refresh external review snapshot for 013e15f6 | 1 | +63/-66 | tooling |  |
| 22 | `013e15f6` | fix: defer coderabbit gates until publish | 11 | +380/-178 | tooling |  |
| 23 | `46de6f81` | Refresh external review snapshot for 4c8aeb5b | 1 | +63/-70 | tooling |  |
| 24 | `4c8aeb5b` | chore: route release checks and review commands | 13 | +285/-61 | tooling |  |
...
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1397/-1408 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-68db695fcb7b` binds this file to HEAD `49d1db53f43a`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
