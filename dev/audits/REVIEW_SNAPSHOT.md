...
- HEAD: `1b42c70ef6cf` — Refresh external review snapshot for df492548
- Tree hash: `569067c22c98`
- Generation stamp: `snap-398bbc7a46f7`
- Generated at (UTC): 2026-05-15T03:53:53Z
- Push decision: `await_checkpoint` — staged_index_present
- Reviewer mode: `single_agent` (interaction: `local_terminal`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 525 files, +12866/-1374
...
- HEAD SHA: `1b42c70ef6cfe6bed30646c40f52ce9e25af5f57`
...
Range: last 24 commits ending at `1b42c70ef6cf`
...
|---|---|---|---|---|---|---|
| 1 | `1b42c70e` | Refresh external review snapshot for df492548 | 2 | +55/-55 | docs |  |
| 2 | `df492548` | MP197: ingest continuous proof scheduler plan | 5 | +160/-50 | tooling |  |
| 3 | `1ec9c8b1` | Refresh external review snapshot for dbd12b71 | 2 | +73/-75 | docs |  |
| 4 | `dbd12b71` | MP188: add runtime bridge separation guard | 14 | +472/-56 | tooling |  |
| 5 | `56d9ceb3` | Refresh external review snapshot for 8d406cee | 2 | +59/-59 | docs |  |
| 6 | `8d406cee` | MP189: ingest R127 wake continuity plan | 5 | +74/-50 | tooling |  |
| 7 | `c99b616c` | Refresh external review snapshot for 763075f1 | 2 | +67/-64 | docs |  |
| 8 | `763075f1` | MP188: register ingestion provenance | 11 | +142/-56 | tooling |  |
| 9 | `31dee106` | Refresh external review snapshot for b7b13c45 | 2 | +64/-64 | docs |  |
| 10 | `b7b13c45` | MP186: retarget R125 duplicate corrections | 18 | +303/-62 | tooling |  |
| 11 | `644389cd` | Refresh external review snapshot for 9272e871 | 2 | +63/-63 | docs |  |
| 12 | `9272e871` | MP381: stabilize push authorization during preflight | 12 | +270/-124 | tooling |  |
| 13 | `b049ba3a` | Refresh external review snapshot for 868e35c9 | 2 | +72/-77 | docs |  |
| 14 | `868e35c9` | MP381: read canonical push authorization | 14 | +223/-64 | tooling |  |
| 15 | `aee417b6` | Refresh external review snapshot for 866ce516 | 2 | +61/-65 | docs |  |
| 16 | `866ce516` | MP381: fix review-channel self-stop preflight | 12 | +177/-61 | tooling |  |
| 17 | `ff501228` | Refresh external review snapshot for d3b7a100 | 2 | +72/-68 | docs |  |
| 18 | `d3b7a100` | MP381: ingest R98 governance findings | 490 | +10105/-155 | tooling |  |
| 19 | `92488df1` | MP377: checkpoint packet-pressure bridge refresh | 1 | +1/-1 | docs |  |
| 20 | `ec6f330e` | MP378: summarize locked review events | 4 | +244/-53 | tooling |  |
| 21 | `e991f288` | MP377: checkpoint packet-pressure reductions | 3 | +3/-1 | tooling |  |
| 22 | `744a4aa9` | MP378: stream review-channel event reads | 5 | +93/-43 | tooling |  |
| 23 | `5fed0004` | MP377: checkpoint reviewer-mode packet reduction | 3 | +4/-2 | tooling |  |
| 24 | `8bd100f9` | MP377: checkpoint packet queue reductions | 3 | +9/-6 | tooling |  |
...
| `dev/active/MASTER_PLAN.md` | tooling | +205/-0 |
| `dev/active/ai_governance_platform.md` | tooling | +27/-0 |
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1084/-1076 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-398bbc7a46f7` binds this file to HEAD `1b42c70ef6cf`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
