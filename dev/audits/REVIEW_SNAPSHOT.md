...
- HEAD: `5fb57f5a72ff` — Refresh external review snapshot for ee079435
- Tree hash: `bebe00eff44e`
- Generation stamp: `snap-03248e2f4a2b`
- Generated at (UTC): 2026-05-20T04:02:05Z
- Push decision: `await_checkpoint` — staged_index_present
- Reviewer mode: `tools_only` (interaction: `local_terminal`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 120 files, +7513/-2323
...
- HEAD SHA: `5fb57f5a72ffa2eea93f7cec6e1ef94c8c32280f`
...
Range: last 24 commits ending at `5fb57f5a72ff`
...
|---|---|---|---|---|---|---|
| 1 | `5fb57f5a` | Refresh external review snapshot for ee079435 | 1 | +52/-52 | tooling |  |
| 2 | `ee079435` | Scope feature proof enforcement to source commits | 3 | +171/-56 | tooling |  |
| 3 | `1489c777` | Refresh external review snapshot for 01290117 | 1 | +48/-48 | tooling |  |
| 4 | `01290117` | Backfill packet binding continuity receipts | 4 | +76/-62 | tooling |  |
| 5 | `3486373d` | Refresh external review snapshot for 30211cd7 | 1 | +51/-51 | tooling |  |
| 6 | `30211cd7` | Record ground truth probe receipt | 2 | +52/-51 | tooling |  |
| 7 | `b8901376` | Refresh external review snapshot for 3b60f794 | 1 | +53/-53 | tooling |  |
| 8 | `3b60f794` | Surface contract connectivity debt at startup | 9 | +533/-54 | tooling |  |
| 9 | `465a3e15` | Refresh external review snapshot for 5835341d | 1 | +60/-62 | tooling |  |
| 10 | `5835341d` | Keep git mutation proof store generated | 6 | +129/-52 | tooling |  |
| 11 | `22dbba15` | Refresh external review snapshot for 38e86f1d | 1 | +55/-58 | tooling |  |
| 12 | `38e86f1d` | Fix managed receipt commit proof coverage | 7 | +442/-121 | tooling |  |
| 13 | `96e66452` | Refresh external review snapshot for 682174e9 | 1 | +64/-67 | tooling |  |
| 14 | `682174e9` | Tighten portable proof guard routing | 11 | +245/-74 | tooling |  |
| 15 | `8b6424e8` | Refresh external review snapshot for 52b445b6 | 1 | +47/-53 | tooling |  |
| 16 | `52b445b6` | Fix control decision consistency guard routing | 10 | +224/-12 | tooling |  |
| 17 | `e6f95248` | Refresh external review snapshot for c2f6777d | 1 | +51/-56 | tooling |  |
| 18 | `c2f6777d` | Fix packet attention receipt drainage | 19 | +835/-40 | tooling |  |
| 19 | `6357774a` | Refresh external review snapshot for 42f2629e | 1 | +93/-94 | tooling |  |
| 20 | `42f2629e` | Checkpoint proof integrity and layout repairs | 72 | +3777/-1019 | tooling |  |
| 21 | `36b1e810` | P0 contract connectivity sub-A: 4 missing authority contrac… | 14 | +260/-26 | tooling |  |
| 22 | `94b95813` | Refresh external review snapshot for 101aacd2 | 1 | +52/-49 | tooling |  |
| 23 | `101aacd2` | Bind reviewer-round intake follow-ups | 4 | +74/-47 | tooling |  |
| 24 | `b126e825` | Refresh external review snapshot for 41217fca | 1 | +69/-66 | tooling |  |
...
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1177/-1192 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-03248e2f4a2b` binds this file to HEAD `5fb57f5a72ff`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
