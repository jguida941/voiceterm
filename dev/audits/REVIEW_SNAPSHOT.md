...
- HEAD: `97992ae29aa4` — Refresh external review snapshot for 81f85b53
- Tree hash: `4612093a485e`
- Generation stamp: `snap-ab4bdb3fb921`
- Generated at (UTC): 2026-05-12T22:49:10Z
- Push decision: `await_checkpoint` — staged_index_present
- Reviewer mode: `single_agent` (interaction: `remote_control`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 246 files, +21559/-1855
...
- HEAD SHA: `97992ae29aa4ab0dc57dd257f144605d61669371`
- HEAD author: Justin Guida
- HEAD timestamp (UTC): 2026-05-12T18:19:20-04:00
...
Range: last 24 commits ending at `97992ae29aa4`
...
|---|---|---|---|---|---|---|
| 1 | `97992ae2` | Refresh external review snapshot for 81f85b53 | 2 | +54/-54 | docs |  |
| 2 | `81f85b53` | Checkpoint live packet projections | 4 | +49/-47 | tooling |  |
| 3 | `454b6230` | Refresh ground truth probe receipt | 2 | +51/-50 | tooling |  |
| 4 | `eddba7ea` | Refresh external review snapshot for 555fa483 | 2 | +56/-56 | docs |  |
| 5 | `555fa483` | Checkpoint push bypass packet projections | 3 | +50/-46 | tooling |  |
| 6 | `05adb548` | Allow publish-clear managed projection receipts | 5 | +145/-52 | tooling |  |
| 7 | `c41a0250` | Refresh external review snapshot for c536d666 | 2 | +59/-59 | docs |  |
| 8 | `c536d666` | Checkpoint post-commit packet projections | 4 | +84/-48 | tooling |  |
| 9 | `ed1fbf18` | Refresh external review snapshot for dea85ab1 | 2 | +60/-58 | docs |  |
| 10 | `dea85ab1` | Fix governed commit pipeline reload fallback | 8 | +417/-54 | tooling |  |
| 11 | `753cf164` | Fix governed commit pipeline retention | 8 | +190/-55 | tooling |  |
| 12 | `cae10c5e` | Refresh external review snapshot for 6bd6f207 | 2 | +60/-59 | docs |  |
| 13 | `6bd6f207` | Fix governed commit pipeline retention | 10 | +230/-56 | tooling |  |
| 14 | `42683c3f` | Refresh external review snapshot for c8cf1c84 | 2 | +49/-48 | docs |  |
| 15 | `c8cf1c84` | Post-commit working tree cleanup: bridge heartbeat + codesm… | 4 | +39/-3 | docs |  |
| 16 | `e76ed6f3` | Refresh external review snapshot for eb336244 | 2 | +82/-76 | docs |  |
| 17 | `eb336244` | Land MP377 BypassLifecycle composability + charter addition… | 48 | +2199/-407 | tooling |  |
| 18 | `b331baa1` | Refresh external review snapshot for 0352553b | 2 | +85/-78 | docs |  |
| 19 | `0352553b` | Checkpoint MP377-P0-CHECKPOINT-AUTOMATION-S1 slice work (cl… | 60 | +3582/-139 | tooling |  |
| 20 | `0928a483` | Stage agent_supervise import set + adapter wiring (recover… | 8 | +808/-2 | tooling |  |
| 21 | `28bcafdd` | Refresh policy-owned generated surfaces for 87554eb9 | 1 | +16/-16 | docs |  |
| 22 | `87554eb9` | Refresh external review snapshot for 9249e17c | 2 | +138/-85 | docs |  |
| 23 | `9249e17c` | Land MP-377 typed governance work-in-progress (multi-slice) | 176 | +12985/-235 | tooling |  |
| 24 | `771a7fa5` | Refresh external review snapshot for 73417c6a | 2 | +71/-72 | docs |  |
...
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1122/-1055 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-ab4bdb3fb921` binds this file to HEAD `97992ae29aa4`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
