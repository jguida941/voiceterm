...
- HEAD: `3b60f7940b49` — Surface contract connectivity debt at startup
- Tree hash: `b41c4fbe1557`
- Generation stamp: `snap-42041e223ec5`
- Generated at (UTC): 2026-05-20T02:55:10Z
- Push decision: `run_devctl_push` — push_preconditions_satisfied
- Reviewer mode: `tools_only` (interaction: `local_terminal`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 128 files, +7607/-2238
...
- HEAD SHA: `3b60f7940b494cf7468adcda24c6c074f909017d`
- HEAD author: Justin Guida
- HEAD timestamp (UTC): 2026-05-19T22:54:14-04:00
...
Range: last 24 commits ending at `3b60f7940b49`
...
|---|---|---|---|---|---|---|
| 1 | `3b60f794` | Surface contract connectivity debt at startup | 9 | +533/-54 | tooling |  |
| 2 | `465a3e15` | Refresh external review snapshot for 5835341d | 1 | +60/-62 | tooling |  |
| 3 | `5835341d` | Keep git mutation proof store generated | 6 | +129/-52 | tooling |  |
| 4 | `22dbba15` | Refresh external review snapshot for 38e86f1d | 1 | +55/-58 | tooling |  |
| 5 | `38e86f1d` | Fix managed receipt commit proof coverage | 7 | +442/-121 | tooling |  |
| 6 | `96e66452` | Refresh external review snapshot for 682174e9 | 1 | +64/-67 | tooling |  |
| 7 | `682174e9` | Tighten portable proof guard routing | 11 | +245/-74 | tooling |  |
| 8 | `8b6424e8` | Refresh external review snapshot for 52b445b6 | 1 | +47/-53 | tooling |  |
| 9 | `52b445b6` | Fix control decision consistency guard routing | 10 | +224/-12 | tooling |  |
| 10 | `e6f95248` | Refresh external review snapshot for c2f6777d | 1 | +51/-56 | tooling |  |
| 11 | `c2f6777d` | Fix packet attention receipt drainage | 19 | +835/-40 | tooling |  |
| 12 | `6357774a` | Refresh external review snapshot for 42f2629e | 1 | +93/-94 | tooling |  |
| 13 | `42f2629e` | Checkpoint proof integrity and layout repairs | 72 | +3777/-1019 | tooling |  |
| 14 | `36b1e810` | P0 contract connectivity sub-A: 4 missing authority contrac… | 14 | +260/-26 | tooling |  |
| 15 | `94b95813` | Refresh external review snapshot for 101aacd2 | 1 | +52/-49 | tooling |  |
| 16 | `101aacd2` | Bind reviewer-round intake follow-ups | 4 | +74/-47 | tooling |  |
| 17 | `b126e825` | Refresh external review snapshot for 41217fca | 1 | +69/-66 | tooling |  |
| 18 | `41217fca` | Allow pending lifecycle packet focus in multi-agent sync | 12 | +249/-52 | tooling |  |
| 19 | `f869134a` | Refresh external review snapshot for 58d527c1 | 1 | +52/-52 | tooling |  |
| 20 | `58d527c1` | Share optional integer coercion across runtime contracts | 9 | +64/-20 | tooling |  |
| 21 | `4f5974fe` | Refresh external review snapshot for b348c95d | 1 | +55/-55 | tooling |  |
| 22 | `b348c95d` | Split multi-agent communication-only focus helper | 8 | +71/-31 | tooling |  |
| 23 | `fd5ca17e` | Refresh external review snapshot for b2639c99 | 1 | +57/-60 | tooling |  |
| 24 | `b2639c99` | Anchor task-started packet bindings to backfill commit | 5 | +49/-18 | tooling |  |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-42041e223ec5` binds this file to HEAD `3b60f7940b49`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
