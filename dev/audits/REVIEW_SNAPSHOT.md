...
- HEAD: `e6fbc7581bc1` — Refresh external review snapshot for 819ec43e
- Tree hash: `6e5f2086687d`
- Generation stamp: `snap-db0c2eb9aa5f`
- Generated at (UTC): 2026-05-03T04:56:57Z
- Push decision: `run_devctl_push` — push_preconditions_satisfied
- Reviewer mode: `single_agent` (interaction: `single_agent`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 97 files, +6640/-1774
...
- HEAD SHA: `e6fbc7581bc116d313c084c1c62b1e3d294b6fb4`
...
Range: last 24 commits ending at `e6fbc7581bc1`
...
|---|---|---|---|---|---|---|
| 1 | `e6fbc758` | Refresh external review snapshot for 819ec43e | 2 | +64/-66 | docs |  |
| 2 | `819ec43e` | Fix stale supervised process audit | 13 | +420/-88 | tooling |  |
| 3 | `0e6730e1` | Refresh external review snapshot for 19d53fbc | 2 | +45/-45 | docs |  |
| 4 | `19d53fbc` | Refresh external review snapshot for ba76cf52 | 1 | +46/-43 | tooling |  |
| 5 | `ba76cf52` | Refresh external review snapshot for 900de219 | 2 | +43/-46 | docs |  |
| 6 | `900de219` | Record review-channel poll projection receipt | 2 | +44/-41 | docs |  |
| 7 | `532f5665` | Refresh external review snapshot for f9176c87 | 2 | +112/-83 | docs |  |
| 8 | `f9176c87` | Checkpoint typed develop and wake routing | 89 | +4809/-588 | tooling |  |
| 9 | `d66f61f2` | Refresh external review snapshot for 8d59ccfb | 2 | +54/-52 | docs |  |
| 10 | `8d59ccfb` | Refresh external review snapshot for 67901df8 | 2 | +69/-65 | docs |  |
| 11 | `67901df8` | Route commit failures through failure packet router | 11 | +273/-87 | tooling |  |
| 12 | `ed38ab8e` | Refresh external review snapshot for 5d00434a | 2 | +46/-48 | docs |  |
| 13 | `5d00434a` | Refresh external review snapshot for 34c4ea42 | 1 | +47/-44 | tooling |  |
| 14 | `34c4ea42` | Refresh external review snapshot for 1733d2a8 | 2 | +60/-60 | docs |  |
| 15 | `1733d2a8` | Integrate packet finding stack into MP-377 plan | 2 | +176/-61 | tooling |  |
| 16 | `82d0bb3a` | Refresh external review snapshot for 48b0e03d | 1 | +42/-39 | tooling |  |
| 17 | `48b0e03d` | Refresh external review snapshot for f04275a0 | 2 | +57/-62 | docs |  |
| 18 | `f04275a0` | chore(push): auto-commit preflight-generated changes | 3 | +56/-58 | tooling |  |
| 19 | `38c938ba` | Refresh external review snapshot for 6ed88467 | 2 | +47/-44 | docs |  |
| 20 | `6ed88467` | Refresh external review snapshot for 50ac1d8a | 1 | +45/-49 | tooling |  |
| 21 | `50ac1d8a` | Refresh plan projection for automation findings | 2 | +2/-0 | tooling |  |
| 22 | `3d02e980` | Refresh review snapshot after system picture update | 1 | +71/-97 | tooling |  |
| 23 | `93f32b7d` | Refresh managed projection surfaces after publisher stop | 3 | +5/-3 | tooling |  |
| 24 | `9d05fe6c` | Refresh managed projection surfaces after publisher update | 3 | +7/-5 | tooling |  |
...
| `dev/active/MASTER_PLAN.md` | tooling | +40/-5 |
| `dev/active/ai_governance_platform.md` | tooling | +187/-0 |
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1174/-1179 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-db0c2eb9aa5f` binds this file to HEAD `e6fbc7581bc1`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
