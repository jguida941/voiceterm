...
- HEAD: `f99de6a3a17b` — docs(audit): Q47 — agent reasons when repo can already compute next step
- Tree hash: `18aea4000ad7`
- Generation stamp: `snap-019de6c6b6f4`
- Generated at (UTC): 2026-04-10T16:08:42Z
- Push decision: `await_checkpoint` — staged_index_budget_exceeded
- Reviewer mode: `single_agent` (interaction: `remote_control`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 17 files, +2178/-1497
...
- HEAD SHA: `f99de6a3a17b8fd46e2f491df7c15fed5d82a363`
- HEAD author: Justin Guida
- HEAD timestamp (UTC): 2026-04-10T12:00:36-04:00
...
Range: last 24 commits ending at `f99de6a3a17b`
...
|---|---|---|---|---|---|---|
| 1 | `f99de6a3` | docs(audit): Q47 — agent reasons when repo can already comp… | 2 | +84/-42 | tooling |  |
| 2 | `b426061d` | docs(audit): Q46 — governance only activates for dual-agent… | 2 | +82/-40 | tooling |  |
| 3 | `83ebf2d6` | docs(audit): Q45 — commit gate missing, evidence ≠ authority | 2 | +88/-56 | tooling |  |
| 4 | `79aab6c1` | docs(audit): Q44 — governed dashboard contradicts itself, m… | 2 | +75/-39 | tooling |  |
| 5 | `8a8d9b4f` | docs(audit): Q42-Q43 — destructive action from observer tel… | 2 | +134/-55 | tooling |  |
| 6 | `7eff1d9b` | docs(audit): Q39-Q41 — state-source drift, role violation,… | 2 | +162/-48 | tooling |  |
| 7 | `e0ef7aa2` | Refresh external review snapshot for 76f753d7 | 1 | +52/-55 | tooling |  |
| 8 | `76f753d7` | docs(audit): Q38 — control plane reasons from intended, not… | 3 | +107/-58 | tooling |  |
| 9 | `652b81d4` | Refresh external review snapshot for efcb2cd9 | 1 | +65/-61 | tooling |  |
| 10 | `efcb2cd9` | fix(audit): close Q37 supervisor-fallback gap + Codex revie… | 13 | +295/-108 | tooling |  |
| 11 | `4b36412c` | Refresh external review snapshot for 95b14712 | 1 | +49/-62 | tooling |  |
| 12 | `95b14712` | Document startup gate authority boundary | 7 | +94/-69 | tooling |  |
| 13 | `dff9cbb2` | Refresh external review snapshot for 8c2ac807 | 1 | +60/-71 | tooling |  |
| 14 | `8c2ac807` | chore: commit concurrent agent changes | 2 | +52/-79 | tooling |  |
| 15 | `8feab0b9` | fix(push): auto-commit runs even after preflight failure to… | 3 | +51/-94 | tooling |  |
| 16 | `f56664d2` | Refresh external review snapshot for 5b0a2d87 | 1 | +53/-49 | tooling |  |
| 17 | `5b0a2d87` | chore: surface refresh after push fix | 3 | +62/-64 | docs |  |
| 18 | `79475b97` | fix(push): auto-commit preflight-generated changes to break… | 3 | +120/-49 | tooling |  |
| 19 | `bd383199` | Refresh external review snapshot for 161f7ef0 | 1 | +53/-52 | tooling |  |
| 20 | `161f7ef0` | chore: push-generated code + surface refresh | 4 | +100/-73 | tooling |  |
| 21 | `bfc8dd3e` | Refresh external review snapshot for 0e2fcf0d | 1 | +51/-52 | tooling |  |
| 22 | `0e2fcf0d` | chore: push-generated surface refresh | 2 | +153/-86 | tooling |  |
| 23 | `4a33bd02` | fix(startup-gate): refined repair-launch bypass with checkp… | 2 | +91/-80 | tooling |  |
| 24 | `7fb42f8e` | Refresh external review snapshot for c3866e56 | 1 | +45/-55 | tooling |  |
...
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1208/-1239 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-019de6c6b6f4` binds this file to HEAD `f99de6a3a17b`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
