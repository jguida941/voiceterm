...
- HEAD: `f1d053bed3a4` — Phase 0.6A: fix packet attention lifecycle routing
- Tree hash: `8da135353907`
- Generation stamp: `snap-a45e647836e6`
- Generated at (UTC): 2026-05-19T11:45:31Z
- Push decision: `run_devctl_push` — push_preconditions_satisfied
- Reviewer mode: `tools_only` (interaction: `local_terminal`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 43 files, +3447/-2434
...
- HEAD SHA: `f1d053bed3a4fe5f50a0da55f714ca31ca361126`
...
Range: last 24 commits ending at `f1d053bed3a4`
...
|---|---|---|---|---|---|---|
| 1 | `f1d053be` | Phase 0.6A: fix packet attention lifecycle routing | 18 | +935/-478 | tooling |  |
| 2 | `81045581` | Refresh external review snapshot for bd76e5a8 | 1 | +58/-56 | tooling |  |
| 3 | `bd76e5a8` | Fix push preflight artifact receipt suppression | 10 | +128/-61 | tooling |  |
| 4 | `2a3787c9` | Refresh external review snapshot for b6a19290 | 1 | +51/-49 | tooling |  |
| 5 | `b6a19290` | Fix push preflight artifact receipt loop | 3 | +68/-71 | tooling |  |
| 6 | `d30618cc` | Refresh external review snapshot for f8b35641 | 1 | +48/-48 | tooling |  |
| 7 | `f8b35641` | Record push preflight artifact receipt | 2 | +59/-61 | tooling |  |
| 8 | `3a98de57` | Refresh external review snapshot for 9471fad2 | 1 | +59/-57 | tooling |  |
| 9 | `9471fad2` | Keep bridge projection guard out of checks root | 10 | +438/-389 | tooling |  |
| 10 | `9a5d3788` | Refresh external review snapshot for ba8eb11f | 1 | +49/-48 | tooling |  |
| 11 | `ba8eb11f` | Record ground-truth probe receipt for GuardIR push | 2 | +63/-60 | tooling |  |
| 12 | `94b93673` | Refresh policy-owned generated surfaces for 1e4a96f7 | 1 | +1/-1 | docs |  |
| 13 | `1e4a96f7` | Refresh external review snapshot for 9ea2c912 | 1 | +65/-69 | tooling |  |
| 14 | `9ea2c912` | Keep bridge report under shape budget | 3 | +93/-78 | tooling |  |
| 15 | `2b0756d3` | Refresh external review snapshot for efc7f761 | 1 | +62/-62 | tooling |  |
| 16 | `efc7f761` | Fix package layout root-scoped ratchet | 10 | +307/-123 | tooling |  |
| 17 | `a5292d33` | Refresh external review snapshot for c6c7052f | 1 | +71/-77 | tooling |  |
| 18 | `c6c7052f` | Wire governance closure CI guard coverage | 10 | +138/-60 | tooling |  |
| 19 | `27a086e3` | Refresh external review snapshot for 6a9b5c68 | 1 | +59/-56 | tooling |  |
| 20 | `6a9b5c68` | Stop claiming real-life proof without pytest nodes | 12 | +123/-61 | tooling |  |
| 21 | `3fbbc5fe` | Refresh external review snapshot for 58db3f97 | 1 | +52/-49 | tooling |  |
| 22 | `58db3f97` | Record ground-truth receipt for release preflight | 2 | +48/-46 | tooling |  |
| 23 | `10ad9a2c` | Refresh external review snapshot for 8afa3efa | 1 | +65/-71 | tooling |  |
| 24 | `8afa3efa` | Classify guard enforcement lanes for release preflight | 15 | +407/-303 | tooling |  |
...
| `AGENTS.md` | docs | +4/-2 |
| `dev/active/MASTER_PLAN.md` | tooling | +31/-4 |
| `dev/active/ai_governance_platform.md` | tooling | +35/-2 |
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1294/-1310 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-a45e647836e6` binds this file to HEAD `f1d053bed3a4`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
