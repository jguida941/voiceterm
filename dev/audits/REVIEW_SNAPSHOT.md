...
- HEAD: `3e35699c39fa` — Fix push-owned commit proof receipts
- Tree hash: `fbfffc27ca54`
- Generation stamp: `snap-58e4dcd7192d`
- Generated at (UTC): 2026-05-20T06:04:18Z
- Push decision: `run_devctl_push` — push_preconditions_satisfied
- Reviewer mode: `tools_only` (interaction: `local_terminal`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 34 files, +2644/-1396
...
- HEAD SHA: `3e35699c39fafb9db978809d048167b9fd94cdcf`
...
Range: last 24 commits ending at `3e35699c39fa`
...
|---|---|---|---|---|---|---|
| 1 | `3e35699c` | Fix push-owned commit proof receipts | 5 | +282/-78 | tooling |  |
| 2 | `af8ef168` | Refresh policy-owned generated surfaces for 58a30236 | 1 | +2/-2 | docs |  |
| 3 | `58a30236` | Refresh external review snapshot for ef1f4365 | 1 | +54/-63 | tooling |  |
| 4 | `ef1f4365` | Record packet attention plan closure | 5 | +51/-48 | tooling |  |
| 5 | `6ec72fd2` | Refresh external review snapshot for 623a21ac | 1 | +60/-61 | tooling |  |
| 6 | `623a21ac` | Fix packet attention drain accounting | 6 | +258/-131 | tooling |  |
| 7 | `a1f4a834` | Refresh external review snapshot for 6f94e606 | 1 | +62/-63 | tooling |  |
| 8 | `6f94e606` | Record contract connectivity plan closure | 5 | +51/-48 | tooling |  |
| 9 | `200af3e3` | Refresh external review snapshot for bad81bdf | 1 | +86/-95 | tooling |  |
| 10 | `bad81bdf` | Gate contract connectivity debt through typed plans | 9 | +277/-55 | tooling |  |
| 11 | `d480a306` | Refresh external review snapshot for b5214fdd | 1 | +48/-49 | tooling |  |
| 12 | `b5214fdd` | Record plan closure for proof ledger guard | 5 | +55/-52 | tooling |  |
| 13 | `acd9bd92` | Refresh external review snapshot for c023e7bc | 1 | +51/-52 | tooling |  |
| 14 | `c023e7bc` | Classify plan closure receipts as proof ledger | 7 | +82/-58 | tooling |  |
| 15 | `5fb57f5a` | Refresh external review snapshot for ee079435 | 1 | +52/-52 | tooling |  |
| 16 | `ee079435` | Scope feature proof enforcement to source commits | 3 | +171/-56 | tooling |  |
| 17 | `1489c777` | Refresh external review snapshot for 01290117 | 1 | +48/-48 | tooling |  |
| 18 | `01290117` | Backfill packet binding continuity receipts | 4 | +76/-62 | tooling |  |
| 19 | `3486373d` | Refresh external review snapshot for 30211cd7 | 1 | +51/-51 | tooling |  |
| 20 | `30211cd7` | Record ground truth probe receipt | 2 | +52/-51 | tooling |  |
| 21 | `b8901376` | Refresh external review snapshot for 3b60f794 | 1 | +53/-53 | tooling |  |
| 22 | `3b60f794` | Surface contract connectivity debt at startup | 9 | +533/-54 | tooling |  |
| 23 | `465a3e15` | Refresh external review snapshot for 5835341d | 1 | +60/-62 | tooling |  |
| 24 | `5835341d` | Keep git mutation proof store generated | 6 | +129/-52 | tooling |  |
...
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1241/-1274 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-58e4dcd7192d` binds this file to HEAD `3e35699c39fa`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
