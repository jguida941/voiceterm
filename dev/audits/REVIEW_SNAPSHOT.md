...
- HEAD: `fbd2993eb033` — Record ground truth receipt for Phase 0.6A push
- Tree hash: `a4e73f99e3f8`
- Generation stamp: `snap-6d421d959d06`
- Generated at (UTC): 2026-05-19T11:55:34Z
- Push decision: `run_devctl_push` — push_preconditions_satisfied
- Reviewer mode: `tools_only` (interaction: `remote_control`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 38 files, +3104/-2184
...
- HEAD SHA: `fbd2993eb033be92f0aacec5b1160ff09e42933f`
- HEAD author: Justin Guida
- HEAD timestamp (UTC): 2026-05-19T07:55:12-04:00
...
Range: last 24 commits ending at `fbd2993eb033`
...
|---|---|---|---|---|---|---|
| 1 | `fbd2993e` | Record ground truth receipt for Phase 0.6A push | 2 | +62/-64 | tooling |  |
| 2 | `cba89fef` | Refresh external review snapshot for f1d053be | 1 | +67/-60 | tooling |  |
| 3 | `f1d053be` | Phase 0.6A: fix packet attention lifecycle routing | 18 | +935/-478 | tooling |  |
| 4 | `81045581` | Refresh external review snapshot for bd76e5a8 | 1 | +58/-56 | tooling |  |
| 5 | `bd76e5a8` | Fix push preflight artifact receipt suppression | 10 | +128/-61 | tooling |  |
| 6 | `2a3787c9` | Refresh external review snapshot for b6a19290 | 1 | +51/-49 | tooling |  |
| 7 | `b6a19290` | Fix push preflight artifact receipt loop | 3 | +68/-71 | tooling |  |
| 8 | `d30618cc` | Refresh external review snapshot for f8b35641 | 1 | +48/-48 | tooling |  |
| 9 | `f8b35641` | Record push preflight artifact receipt | 2 | +59/-61 | tooling |  |
| 10 | `3a98de57` | Refresh external review snapshot for 9471fad2 | 1 | +59/-57 | tooling |  |
| 11 | `9471fad2` | Keep bridge projection guard out of checks root | 10 | +438/-389 | tooling |  |
| 12 | `9a5d3788` | Refresh external review snapshot for ba8eb11f | 1 | +49/-48 | tooling |  |
| 13 | `ba8eb11f` | Record ground-truth probe receipt for GuardIR push | 2 | +63/-60 | tooling |  |
| 14 | `94b93673` | Refresh policy-owned generated surfaces for 1e4a96f7 | 1 | +1/-1 | docs |  |
| 15 | `1e4a96f7` | Refresh external review snapshot for 9ea2c912 | 1 | +65/-69 | tooling |  |
| 16 | `9ea2c912` | Keep bridge report under shape budget | 3 | +93/-78 | tooling |  |
| 17 | `2b0756d3` | Refresh external review snapshot for efc7f761 | 1 | +62/-62 | tooling |  |
| 18 | `efc7f761` | Fix package layout root-scoped ratchet | 10 | +307/-123 | tooling |  |
| 19 | `a5292d33` | Refresh external review snapshot for c6c7052f | 1 | +71/-77 | tooling |  |
| 20 | `c6c7052f` | Wire governance closure CI guard coverage | 10 | +138/-60 | tooling |  |
| 21 | `27a086e3` | Refresh external review snapshot for 6a9b5c68 | 1 | +59/-56 | tooling |  |
| 22 | `6a9b5c68` | Stop claiming real-life proof without pytest nodes | 12 | +123/-61 | tooling |  |
| 23 | `3fbbc5fe` | Refresh external review snapshot for 58db3f97 | 1 | +52/-49 | tooling |  |
| 24 | `58db3f97` | Record ground-truth receipt for release preflight | 2 | +48/-46 | tooling |  |

### Files

| Path | Bundle | +/- |
|---|---|---|
| `.github/workflows/tooling_control_plane.yml` | tooling | +32/-0 |
| `AGENTS.md` | docs | +3/-2 |
| `dev/active/MASTER_PLAN.md` | tooling | +26/-4 |
| `dev/active/ai_governance_platform.md` | tooling | +28/-2 |
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1305/-1316 |
| `dev/guides/DEVELOPMENT.md` | docs | +27/-5 |
| `dev/guides/SYSTEM_MAP.md` | docs | +3/-3 |
| `dev/history/ENGINEERING_EVOLUTION.md` | tooling | +137/-0 |
| `dev/scripts/README.md` | tooling | +28/-8 |
...
| `dev/scripts/devctl/commands/development/packet_attention.py` | tooling | +18/-85 |
| `dev/scripts/devctl/commands/development/packet_attention_body_followup.py` | tooling | +215/-0 |
| `dev/scripts/devctl/governance/instruction_boot_card.py` | tooling | +3/-2 |
...
| `dev/scripts/devctl/runtime/control_decision_artifacts.py` | tooling | +5/-323 |
| `dev/scripts/devctl/runtime/control_decision_packet_agent_sync.py` | tooling | +41/-0 |
| `dev/scripts/devctl/runtime/control_decision_packet_ids.py` | tooling | +50/-0 |
| `dev/scripts/devctl/runtime/control_decision_packet_inbox.py` | tooling | +144/-0 |
| `dev/scripts/devctl/runtime/control_decision_packet_inbox_scope.py` | tooling | +50/-0 |
| `dev/scripts/devctl/runtime/control_decision_packet_lifecycle.py` | tooling | +122/-0 |
...
| `dev/scripts/devctl/tests/commands/test_development_command.py` | tooling | +118/-1 |
| `dev/scripts/devctl/tests/runtime/test_commit_receipt.py` | tooling | +6/-3 |
| `dev/scripts/devctl/tests/runtime/test_control_decision_artifacts.py` | tooling | +58/-0 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-6d421d959d06` binds this file to HEAD `fbd2993eb033`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
