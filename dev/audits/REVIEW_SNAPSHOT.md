...
- HEAD: `38cb9e95c474` — fix(review-channel): Q94 — emit participant_liveness_expired on heartbeat TTL expiry
- Tree hash: `6757d3a1d479`
- Generation stamp: `snap-24fc69b686ff`
- Generated at (UTC): 2026-04-11T07:21:35Z
- Push decision: `run_devctl_push` — push_preconditions_satisfied
- Reviewer mode: `single_agent` (interaction: `remote_control`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 25 commits, 40 files, +6469/-1676
...
- HEAD SHA: `38cb9e95c47490a0acb4fbc673abb39673c46f0b`
- HEAD author: Justin Guida
- HEAD timestamp (UTC): 2026-04-11T03:16:45-04:00
...
Range: last 25 commits ending at `38cb9e95c474`
...
|---|---|---|---|---|---|---|
| 1 | `38cb9e95` | fix(review-channel): Q94 — emit participant_liveness_expire… | 6 | +437/-111 | tooling |  |
...
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1462/-1510 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-24fc69b686ff` binds this file to HEAD `38cb9e95c474`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
