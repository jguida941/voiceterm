...
- HEAD: `d3cf4e7313d8` — Harden packet attention and routed guard coverage
- Tree hash: `11eec5fe68d8`
- Generation stamp: `snap-e554370bf719`
- Generated at (UTC): 2026-05-04T04:22:41Z
- Push decision: `run_devctl_push` — push_preconditions_satisfied
- Reviewer mode: `single_agent` (interaction: `local_terminal`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 91 files, +4811/-3764
...
- HEAD SHA: `d3cf4e7313d8f733befc2e506750afc50949b94e`
- HEAD author: Justin Guida
- HEAD timestamp (UTC): 2026-05-04T00:22:23-04:00
...
Range: last 24 commits ending at `d3cf4e7313d8`
...
|---|---|---|---|---|---|---|
| 1 | `d3cf4e73` | Harden packet attention and routed guard coverage | 72 | +2469/-2618 | tooling |  |
| 2 | `2a3e3731` | Refresh external review snapshot for 764252dc | 2 | +43/-43 | docs |  |
| 3 | `764252dc` | Refresh external review snapshot for bc821042 | 2 | +48/-45 | docs |  |
| 4 | `bc821042` | Refresh external review snapshot for c2cf00e6 | 2 | +68/-67 | docs |  |
| 5 | `c2cf00e6` | Preserve priority action-request current session | 14 | +347/-92 | tooling |  |
| 6 | `71258903` | Refresh external review snapshot for c3b8b148 | 2 | +43/-43 | docs |  |
| 7 | `c3b8b148` | Refresh external review snapshot for 6d9e177d | 2 | +43/-45 | docs |  |
| 8 | `6d9e177d` | Refresh external review snapshot for 26a94370 | 2 | +66/-72 | docs |  |
| 9 | `26a94370` | Absorb projection drift to clear governed-push gate per cod… | 3 | +9/-7 | tooling |  |
| 10 | `d1b3377b` | Refresh external review snapshot for dae2c50e | 2 | +86/-88 | docs |  |
| 11 | `dae2c50e` | Tighten operator notice sync guard | 12 | +297/-127 | tooling |  |
| 12 | `1096b88d` | Implement codex's rev_pkt_2922 (Finding Y) + rev_pkt_2923 (… | 7 | +196/-16 | tooling |  |
| 13 | `1761e564` | Absorb projection drift to clear startup gate before termin… | 3 | +7/-5 | tooling |  |
| 14 | `0bba7ed5` | Absorb projection drift to clear bridge guard ACK mismatch… | 3 | +23/-12 | tooling |  |
| 15 | `14945bd5` | Tighten remote_control wake routing per codex rev_pkt_2904 | 3 | +122/-1 | tooling |  |
| 16 | `8c61c403` | Refresh external review snapshot for 8da8cee3 | 2 | +44/-44 | docs |  |
| 17 | `8da8cee3` | Refresh external review snapshot for 1bf050cb | 1 | +44/-44 | tooling |  |
| 18 | `1bf050cb` | Refresh policy-owned generated surfaces for 66480513 | 1 | +1/-1 | docs |  |
| 19 | `66480513` | Refresh external review snapshot for b5a3728c | 2 | +70/-69 | docs |  |
| 20 | `b5a3728c` | Phase 1.5: tighten remote_control wake/launch scope per rev… | 9 | +241/-67 | tooling |  |
| 21 | `63171e06` | Refresh external review snapshot for 689b31b2 | 2 | +60/-61 | docs |  |
| 22 | `689b31b2` | Unblock remote-control codex launch (Findings D + F minimal… | 8 | +274/-59 | tooling |  |
| 23 | `19b907d1` | Refresh external review snapshot for ebc0732d | 2 | +62/-62 | docs |  |
| 24 | `ebc0732d` | Suppress packet-post auto-spawn in remote_control mode (Fin… | 6 | +148/-76 | tooling |  |
...
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +990/-997 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-e554370bf719` binds this file to HEAD `d3cf4e7313d8`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
