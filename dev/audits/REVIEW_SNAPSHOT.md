...
- HEAD: `36a1a87bb20e` — Honor docs-check generated surface aliases
- Tree hash: `a1c2df0ac137`
- Generation stamp: `snap-e88f9759cdea`
- Generated at (UTC): 2026-05-13T04:51:34Z
- Push decision: `run_devctl_push` — push_preconditions_satisfied
- Reviewer mode: `single_agent` (interaction: `remote_control`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 75 files, +5527/-4295
...
- HEAD SHA: `36a1a87bb20e9ddcc16c3db3c733497a67db66f7`
- HEAD author: Justin Guida
- HEAD timestamp (UTC): 2026-05-13T00:51:01-04:00
...
Range: last 24 commits ending at `36a1a87bb20e`
...
|---|---|---|---|---|---|---|
| 1 | `36a1a87b` | Honor docs-check generated surface aliases | 11 | +177/-60 | tooling |  |
| 2 | `ee552370` | Refresh external review snapshot for f0d0b9db | 2 | +64/-64 | docs |  |
| 3 | `f0d0b9db` | Improve governance CLI dogfood ergonomics | 12 | +129/-55 | tooling |  |
| 4 | `63ce7cbe` | Refresh external review snapshot for 3e9b18d8 | 2 | +56/-55 | docs |  |
| 5 | `3e9b18d8` | Record post-push governance updates | 3 | +87/-56 | docs |  |
| 6 | `47b6ac17` | Refresh external review snapshot for 285123c6 | 2 | +52/-52 | docs |  |
| 7 | `285123c6` | chore(push): auto-commit preflight-generated changes | 1 | +61/-0 | docs |  |
| 8 | `10c86a85` | Refresh external review snapshot for 63e6af81 | 2 | +68/-62 | docs |  |
| 9 | `63e6af81` | Update governed executor projection path test | 5 | +96/-59 | tooling |  |
| 10 | `5734839a` | Refresh external review snapshot for 5340d350 | 2 | +60/-60 | docs |  |
| 11 | `5340d350` | Register Claude automation safety declaration | 3 | +102/-49 | tooling |  |
| 12 | `80fbb684` | Refresh external review snapshot for b4acaba1 | 2 | +58/-66 | docs |  |
| 13 | `b4acaba1` | Allow review-only action requests through commit gate | 4 | +202/-102 | tooling |  |
| 14 | `2135698e` | Refresh external review snapshot for d700ecb9 | 2 | +57/-57 | docs |  |
| 15 | `d700ecb9` | Reuse CLI command handler rows | 2 | +59/-70 | tooling |  |
| 16 | `2aac05ed` | Refresh external review snapshot for aaf17ee5 | 2 | +63/-67 | docs |  |
| 17 | `aaf17ee5` | Reduce orchestration adapter parameter surfaces | 5 | +92/-153 | tooling |  |
| 18 | `376cd632` | Refresh policy-owned generated surfaces for 7f3a73c8 | 1 | +2/-2 | docs |  |
| 19 | `7f3a73c8` | Refresh external review snapshot for a1c11da2 | 2 | +70/-69 | docs |  |
| 20 | `a1c11da2` | Split governance modules for code shape compliance | 42 | +3643/-2792 | tooling |  |
| 21 | `a9415b9a` | Refresh policy-owned generated surfaces for 7e006123 | 1 | +1/-1 | docs |  |
| 22 | `7e006123` | Refresh external review snapshot for 8d5bb18a | 2 | +56/-53 | docs |  |
| 23 | `8d5bb18a` | Checkpoint listing package projections | 4 | +51/-49 | tooling |  |
| 24 | `32545d54` | Package devctl list command | 4 | +221/-242 | tooling |  |
...
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1215/-1264 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-e88f9759cdea` binds this file to HEAD `36a1a87bb20e`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
