...
- HEAD: `c9616cfe8173` — Fix push bridge sync test mocks
- Tree hash: `49a037dabc52`
- Generation stamp: `snap-199a5f325581`
- Generated at (UTC): 2026-05-11T13:09:53Z
- Push decision: `run_devctl_push` — push_preconditions_satisfied
- Reviewer mode: `tools_only` (interaction: `remote_control`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 64 files, +3017/-2127
...
- HEAD SHA: `c9616cfe8173f54a0f10d461224ad3b72b6a59d8`
...
Range: last 24 commits ending at `c9616cfe8173`
...
|---|---|---|---|---|---|---|
| 1 | `c9616cfe` | Fix push bridge sync test mocks | 4 | +51/-56 | tooling |  |
| 2 | `170167c1` | Refresh external review snapshot for fe5b9538 | 2 | +66/-65 | docs |  |
| 3 | `fe5b9538` | Fix startup reviewer mode authority | 5 | +95/-60 | tooling |  |
| 4 | `18685099` | Refresh external review snapshot for c4e50e10 | 2 | +40/-40 | docs |  |
| 5 | `c4e50e10` | Refresh external review snapshot for 1036a84b | 2 | +64/-64 | docs |  |
| 6 | `1036a84b` | Document push preflight projection policy | 9 | +94/-55 | tooling |  |
| 7 | `8b8900d6` | Refresh external review snapshot for 0fa60654 | 2 | +64/-62 | docs |  |
| 8 | `0fa60654` | Fix push preflight audit routing | 8 | +185/-59 | tooling |  |
| 9 | `5b5c0d06` | Refresh external review snapshot for 9aba52e2 | 1 | +40/-40 | tooling |  |
| 10 | `9aba52e2` | Refresh policy-owned generated surfaces for 905794d7 | 1 | +1/-1 | docs |  |
| 11 | `905794d7` | Refresh external review snapshot for 5068dcf7 | 2 | +66/-67 | docs |  |
| 12 | `5068dcf7` | Fix push preflight report backpressure | 6 | +264/-103 | tooling |  |
| 13 | `bc5bc45d` | Refresh external review snapshot for da712f39 | 1 | +52/-52 | tooling |  |
| 14 | `da712f39` | Refresh external review snapshot for c1d6f59f | 2 | +46/-47 | docs |  |
| 15 | `c1d6f59f` | Refresh external review snapshot for 35002759 | 2 | +72/-71 | docs |  |
| 16 | `35002759` | Fix review-channel declared mode authority | 21 | +378/-180 | tooling |  |
| 17 | `9318cfd0` | Refresh external review snapshot for d555dc0f | 1 | +54/-55 | tooling |  |
| 18 | `d555dc0f` | Refresh external review snapshot for df64f077 | 2 | +62/-62 | docs |  |
| 19 | `df64f077` | Keep communication-only packets out of instruction authority | 5 | +172/-85 | tooling |  |
| 20 | `f14b9338` | Refresh external review snapshot for 827ffafb | 2 | +45/-45 | docs |  |
| 21 | `827ffafb` | Refresh policy-owned generated surfaces for c82c610b | 1 | +1/-1 | docs |  |
| 22 | `c82c610b` | Refresh external review snapshot for 3c067775 | 2 | +70/-71 | docs |  |
| 23 | `3c067775` | Split review-state and push authority responsibilities | 24 | +992/-743 | tooling |  |
| 24 | `87f8b2dd` | Refresh external review snapshot for 7a094406 | 1 | +43/-43 | tooling |  |
...
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1186/-1185 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-199a5f325581` binds this file to HEAD `c9616cfe8173`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
