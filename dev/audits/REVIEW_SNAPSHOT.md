...
- HEAD: `cba89fefa434` — Refresh external review snapshot for f1d053be
- Tree hash: `3f3185d6bedf`
- Generation stamp: `snap-74378188952b`
- Generated at (UTC): 2026-05-19T11:51:40Z
- Push decision: `await_checkpoint` — staged_index_present
- Reviewer mode: `tools_only` (interaction: `local_terminal`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 38 files, +3107/-2191
...
- HEAD SHA: `cba89fefa434f73a6120ca5e6d381e471a9a301e`
- HEAD author: Justin Guida
- HEAD timestamp (UTC): 2026-05-19T07:45:09-04:00
...
Range: last 24 commits ending at `cba89fefa434`
...
|---|---|---|---|---|---|---|
| 1 | `cba89fef` | Refresh external review snapshot for f1d053be | 1 | +67/-60 | tooling |  |
| 2 | `f1d053be` | Phase 0.6A: fix packet attention lifecycle routing | 18 | +935/-478 | tooling |  |
| 3 | `81045581` | Refresh external review snapshot for bd76e5a8 | 1 | +58/-56 | tooling |  |
| 4 | `bd76e5a8` | Fix push preflight artifact receipt suppression | 10 | +128/-61 | tooling |  |
| 5 | `2a3787c9` | Refresh external review snapshot for b6a19290 | 1 | +51/-49 | tooling |  |
| 6 | `b6a19290` | Fix push preflight artifact receipt loop | 3 | +68/-71 | tooling |  |
| 7 | `d30618cc` | Refresh external review snapshot for f8b35641 | 1 | +48/-48 | tooling |  |
| 8 | `f8b35641` | Record push preflight artifact receipt | 2 | +59/-61 | tooling |  |
| 9 | `3a98de57` | Refresh external review snapshot for 9471fad2 | 1 | +59/-57 | tooling |  |
| 10 | `9471fad2` | Keep bridge projection guard out of checks root | 10 | +438/-389 | tooling |  |
| 11 | `9a5d3788` | Refresh external review snapshot for ba8eb11f | 1 | +49/-48 | tooling |  |
| 12 | `ba8eb11f` | Record ground-truth probe receipt for GuardIR push | 2 | +63/-60 | tooling |  |
| 13 | `94b93673` | Refresh policy-owned generated surfaces for 1e4a96f7 | 1 | +1/-1 | docs |  |
| 14 | `1e4a96f7` | Refresh external review snapshot for 9ea2c912 | 1 | +65/-69 | tooling |  |
| 15 | `9ea2c912` | Keep bridge report under shape budget | 3 | +93/-78 | tooling |  |
| 16 | `2b0756d3` | Refresh external review snapshot for efc7f761 | 1 | +62/-62 | tooling |  |
| 17 | `efc7f761` | Fix package layout root-scoped ratchet | 10 | +307/-123 | tooling |  |
| 18 | `a5292d33` | Refresh external review snapshot for c6c7052f | 1 | +71/-77 | tooling |  |
| 19 | `c6c7052f` | Wire governance closure CI guard coverage | 10 | +138/-60 | tooling |  |
| 20 | `27a086e3` | Refresh external review snapshot for 6a9b5c68 | 1 | +59/-56 | tooling |  |
| 21 | `6a9b5c68` | Stop claiming real-life proof without pytest nodes | 12 | +123/-61 | tooling |  |
| 22 | `3fbbc5fe` | Refresh external review snapshot for 58db3f97 | 1 | +52/-49 | tooling |  |
| 23 | `58db3f97` | Record ground-truth receipt for release preflight | 2 | +48/-46 | tooling |  |
| 24 | `10ad9a2c` | Refresh external review snapshot for 8afa3efa | 1 | +65/-71 | tooling |  |
...
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1309/-1323 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-74378188952b` binds this file to HEAD `cba89fefa434`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
