...
- HEAD: `82d0bb3aceb4` — Refresh external review snapshot for 48b0e03d
- Tree hash: `372b3829583d`
- Generation stamp: `snap-23f850858108`
- Generated at (UTC): 2026-05-02T20:48:21Z
- Push decision: `await_checkpoint` — staged_index_present
- Reviewer mode: `single_agent` (interaction: `local_terminal`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 24 commits, 22 files, +2048/-1277
...
- HEAD SHA: `82d0bb3aceb486ea2708a3aa4797db5e660d6247`
- HEAD author: Justin Guida
- HEAD timestamp (UTC): 2026-05-02T16:27:33-04:00
...
Range: last 24 commits ending at `82d0bb3aceb4`
...
|---|---|---|---|---|---|---|
| 1 | `82d0bb3a` | Refresh external review snapshot for 48b0e03d | 1 | +42/-39 | tooling |  |
| 2 | `48b0e03d` | Refresh external review snapshot for f04275a0 | 2 | +57/-62 | docs |  |
| 3 | `f04275a0` | chore(push): auto-commit preflight-generated changes | 3 | +56/-58 | tooling |  |
| 4 | `38c938ba` | Refresh external review snapshot for 6ed88467 | 2 | +47/-44 | docs |  |
| 5 | `6ed88467` | Refresh external review snapshot for 50ac1d8a | 1 | +45/-49 | tooling |  |
| 6 | `50ac1d8a` | Refresh plan projection for automation findings | 2 | +2/-0 | tooling |  |
| 7 | `3d02e980` | Refresh review snapshot after system picture update | 1 | +71/-97 | tooling |  |
| 8 | `93f32b7d` | Refresh managed projection surfaces after publisher stop | 3 | +5/-3 | tooling |  |
| 9 | `9d05fe6c` | Refresh managed projection surfaces after publisher update | 3 | +7/-5 | tooling |  |
| 10 | `b8dfb984` | Refresh managed projection surfaces after drift repair | 4 | +67/-55 | tooling |  |
| 11 | `8a361a42` | Refresh external review snapshot for f510da77 | 2 | +65/-69 | docs |  |
| 12 | `f510da77` | Fix empty develop packet attention summary | 11 | +160/-83 | tooling |  |
| 13 | `5908bcd9` | Refresh external review snapshot for a2c85e4a | 2 | +47/-47 | docs |  |
| 14 | `a2c85e4a` | Refresh external review snapshot for 4baabf40 | 1 | +53/-50 | tooling |  |
| 15 | `4baabf40` | Refresh policy-owned generated surfaces for 2cc4bd10 | 1 | +1/-1 | docs |  |
| 16 | `2cc4bd10` | Refresh external review snapshot for 7a3579b1 | 2 | +66/-64 | docs |  |
| 17 | `7a3579b1` | Persist launcher discipline bypass receipts | 8 | +452/-119 | tooling |  |
| 18 | `3ff41ec7` | Refresh external review snapshot for 117ea0d3 | 2 | +58/-58 | docs |  |
| 19 | `117ea0d3` | Preserve single-agent topology mode | 2 | +101/-135 | tooling |  |
| 20 | `625580af` | Refresh policy-owned generated surfaces for c3adea3a | 1 | +1/-1 | docs |  |
| 21 | `c3adea3a` | Refresh external review snapshot for ff9988fe | 2 | +57/-54 | docs |  |
| 22 | `ff9988fe` | Add failure packet router | 3 | +467/-57 | tooling |  |
| 23 | `11ede1db` | Refresh external review snapshot for 492a2f37 | 2 | +64/-78 | docs |  |
| 24 | `492a2f37` | drift before reviewer launch | 4 | +57/-49 | tooling |  |
...
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1111/-1202 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-23f850858108` binds this file to HEAD `82d0bb3aceb4`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
