...
- HEAD: `b632df44813e` — Refresh external review snapshot for ad84e97b
- Tree hash: `116ef16d0488`
- Generation stamp: `snap-636332e0ce13`
- Generated at (UTC): 2026-05-16T21:10:49Z
- Push decision: `await_checkpoint` — staged_index_present
- Reviewer mode: `single_agent` (interaction: `remote_control`)
- Pipeline state: `n/a` (approval: `n/a`)
- Delta since last snapshot: 25 commits, 178 files, +10213/-1807
...
- HEAD SHA: `b632df44813eea9770146eef36b3e208edbf59bd`
- HEAD author: Justin Guida
- HEAD timestamp (UTC): 2026-05-16T16:56:15-04:00
...
Range: last 25 commits ending at `b632df44813e`
...
|---|---|---|---|---|---|---|
| 1 | `b632df44` | Refresh external review snapshot for ad84e97b | 2 | +64/-70 | docs |  |
| 2 | `ad84e97b` | MP-378 record pytest nodes in feature proof receipts | 4 | +196/-49 | tooling |  |
| 3 | `00ab91b8` | Refresh external review snapshot for 494e0914 | 2 | +65/-73 | docs |  |
| 4 | `494e0914` | MP-378 require role review timeout governance chain | 3 | +141/-53 | tooling |  |
| 5 | `b707ad20` | Refresh external review snapshot for aa840939 | 2 | +58/-62 | docs |  |
| 6 | `aa840939` | MP-378 add governed transition typechecker proof | 8 | +1149/-68 | tooling |  |
| 7 | `ab38e2a8` | Refresh external review snapshot for b38d2bd7 | 2 | +59/-64 | docs |  |
| 8 | `b38d2bd7` | MP-378 add bypass expire error code proof | 7 | +61/-52 | tooling |  |
| 9 | `9283311c` | Refresh external review snapshot for 54bb3a07 | 2 | +66/-75 | docs |  |
| 10 | `54bb3a07` | MP-378 repair packet debt and bypass expiry proof | 19 | +800/-143 | tooling |  |
| 11 | `12328ec3` | Refresh external review snapshot for e9de52ef | 2 | +67/-73 | docs |  |
| 12 | `e9de52ef` | MP-NEW-P209 add bypass expire CLI | 7 | +384/-68 | tooling |  |
| 13 | `4ca0ae78` | MP-NEW-P208 enforce terminal role-review proof | 32 | +1077/-118 | tooling |  |
| 14 | `3e795e8e` | Refresh external review snapshot for eb937a97 | 2 | +52/-55 | docs |  |
| 15 | `eb937a97` | MP377-P0-T22AN-AB: record closure receipts for cf51bd8a | 2 | +4/-2 | tooling |  |
| 16 | `ba0512b6` | Refresh external review snapshot for cf51bd8a | 2 | +45/-49 | docs |  |
| 17 | `cf51bd8a` | MP377-P0-T22AN-AB: close role-review fixtures and TTL drift | 15 | +405/-20 | tooling |  |
| 18 | `a2746730` | Refresh external review snapshot for 55c53a5b | 2 | +67/-66 | docs |  |
| 19 | `55c53a5b` | Add role-review lifecycle and pytest policy proof | 16 | +861/-151 | tooling |  |
| 20 | `cdb1b09d` | Refresh external review snapshot for 82d5e789 | 2 | +44/-46 | docs |  |
| 21 | `82d5e789` | MP-NEW-P230-OUTPUT-TRUTH-SPINE-S1: record closure receipts | 2 | +2/-1 | tooling |  |
| 22 | `d0e99b9a` | Refresh external review snapshot for a3303fd5 | 2 | +88/-82 | docs |  |
| 23 | `a3303fd5` | MP-NEW-P230-OUTPUT-TRUTH-SPINE-S1: ship keystone proof spine | 126 | +4318/-300 | tooling |  |
| 24 | `e8dd613a` | Refresh external review snapshot for 850b9015 | 2 | +66/-66 | docs |  |
| 25 | `850b9015` | MP-NEW-P229-COMMIT-TO-PLAN-ROW-REDUCER-S1: persist plan-row… | 4 | +74/-1 | tooling |  |
...
| `dev/active/ai_governance_platform.md` | tooling | +26/-0 |
| `dev/audits/REVIEW_SNAPSHOT.md` | tooling | +1136/-1169 |
| `dev/guides/DEVELOPMENT.md` | docs | +15/-0 |
| `dev/guides/SYSTEM_MAP.md` | docs | +48/-46 |
...
| `dev/scripts/devctl/commands/raw_git.py` | tooling | +15/-28 |
...
| `dev/scripts/devctl/platform/runtime_identity_contract_rows_commit.py` | tooling | +111/-0 |
...
Projection produced by `devctl review-snapshot`. Generation stamp `snap-636332e0ce13` binds this file to HEAD `b632df44813e`; if they drift, the freshness guard will fail CI. When the latest commit only refreshes this generated snapshot, the guard accepts this file as bound to that commit's parent code state.
