...
4.4 In live review-channel mode, treat
    ...
    it replaces only the stale Claude conductor, while `launch|rollover`
    remain the fresh-session relaunch paths.
