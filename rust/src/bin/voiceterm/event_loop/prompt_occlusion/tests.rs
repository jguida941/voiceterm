...
fn synchronized_cursor_activity_detects_thinking_packets() {
    ...
    assert!(chunk_contains_claude_synchronized_cursor_activity(packet));
}
...
fn synchronized_cursor_activity_identifies_prompt_input_echo_rewrites() {
    ...
    assert!(chunk_is_probable_claude_prompt_input_echo_rewrite(packet));
}
...
fn synchronized_cursor_activity_ignores_non_rewrite_packets() {
    assert!(!chunk_contains_claude_synchronized_cursor_activity(
