...
Usage:
  scripts/tests/compare_python_rust_stt_strict.sh [options]
...
Examples:
  scripts/tests/compare_python_rust_stt_strict.sh --count 3 --secs 3
  scripts/tests/compare_python_rust_stt_strict.sh --count 5 --whisper-model base.en
EOF
}
