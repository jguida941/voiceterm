...
Usage:
  scripts/tests/compare_python_rust_voice_latency.sh [--count N] [--auto-install-whisper|--no-auto-install-whisper] [--python-cmd CMD] [latency_measurement args...]

Examples:
  scripts/tests/compare_python_rust_voice_latency.sh --count 3
  scripts/tests/compare_python_rust_voice_latency.sh --count 3 --secs 3 --tail-ms 1500 --max-capture-ms 45000
  scripts/tests/compare_python_rust_voice_latency.sh --count 2 --min-voice-total-ms 400
  scripts/tests/compare_python_rust_voice_latency.sh --count 3 --voice-silence-tail-ms 1500 --voice-max-capture-ms 45000
  scripts/tests/compare_python_rust_voice_latency.sh --count 3 --auto-install-whisper
  scripts/tests/compare_python_rust_voice_latency.sh --count 3 --auto-install-whisper --python-cmd python
...
ensure_whisper_cli() {
  ...
  if ! command -v whisper >/dev/null 2>&1; then
    ...
    echo "  scripts/tests/compare_python_rust_voice_latency.sh --auto-install-whisper --count 3" >&2
